...
def build_doopdb_program() -> Program:
  ...
  return Program(
    ...
    rules=[
      ...
      (
        Reachable(tometh) <= Reachable(inmeth) & StaticMethodInvocation(invocation, tometh, inmeth)
      ).named('Static_MultiHead_h0'),
      (
        CallGraphEdge(invocation, tometh)
        <= Reachable(inmeth) & StaticMethodInvocation(invocation, tometh, inmeth)
      ).named('Static_MultiHead_h1'),
      (
      ...
      (
        VarPointsTo(heap, thisP)
        <= ReachableInstruction(invocation)
        & VirtualMethodInvocation(invocation, base, simplename, descriptor)
        & VarPointsTo(heap, base)
        & HeapHelper(simplename, descriptor, toMeth, thisP, heap)
      )
      .named('VirtualDispatch_MultiHead_h0')
      .with_plan(
        delta=2,
      ...
      .named('VirtualDispatch_MultiHead_h1')
      .with_plan(
        delta=2,
        var_order=['base', 'heap', 'invocation', 'simplename', 'descriptor', 'toMeth', 'thisP'],
        block_group=True,
      ...
      .named('VirtualDispatch_MultiHead_h2')
      .with_plan(
        delta=2,
        var_order=['base', 'heap', 'invocation', 'simplename', 'descriptor', 'toMeth', 'thisP'],
        block_group=True,
      ...
      .named('Reachable_CGE_Virtual_h0')
      .with_plan(
        delta=2,
      ...
      .named('Reachable_CGE_Virtual_h1')
      .with_plan(
        delta=2,
        var_order=['base', 'heap', 'invocation', 'simplename', 'descriptor', 'toMeth'],
        block_group=True,
      ...
      (
        ...
        & ThisVar(tometh, thisP)
      ).named('SpecialDispatch_MultiHead_h0'),
      (
        CallGraphEdge(invocation, tometh)
        <= ReachableInstruction(invocation)
        & SpecialMethodInvocation_Base(invocation, base)
        ...
        & MethodInvocation_Method(invocation, tometh)
        & ThisVar(tometh, thisP)
      ).named('SpecialDispatch_MultiHead_h1'),
      (
        Reachable(tometh)
        <= ReachableInstruction(invocation)
        & SpecialMethodInvocation_Base(invocation, base)
        ...
        & MethodInvocation_Method(invocation, tometh)
        & ThisVar(tometh, thisP)
      ).named('SpecialDispatch_MultiHead_h2'),
      (
