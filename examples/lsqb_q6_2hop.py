"""Auto-generated from /home/stargazermiao/workspace/SRDatalog/integration_tests/examples/triangle/lsqb_q6_2hop.nim by tools/nim_to_dsl.py.
Do not edit manually — regenerate via:

    python tools/nim_to_dsl.py /home/stargazermiao/workspace/SRDatalog/integration_tests/examples/triangle/lsqb_q6_2hop.nim --out <this file>
"""
...
def build_lsqb_q6_db_program() -> Program:
  ...
  return Program(
    ...
    rules=[
      ...
      (Path(p1, p2, p3, t) <= Knows(p1, p2) & Knows(p2, p3) & HasInterest(p3, t) & Filter(('p1', 'p3',), "return p1 != p3;")).named('TwoHopPath').with_plan(var_order=['p1', 'p2', 'p3', 't']),
    ],
  )


def build_lsqb_q6_db(meta_json_path: str) -> tuple[Program, dict[str, int]]:
  """Convenience: build the program, load dataset_consts, substitute."""
  consts = load_meta(meta_json_path, DATASET_CONST_DECLS)
  return resolve_program_consts(build_lsqb_q6_db_program(), consts), consts
