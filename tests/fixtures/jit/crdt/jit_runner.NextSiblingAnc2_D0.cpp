...
struct JitRunner_NextSiblingAnc2_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    // MIR: (column-join :var ParentCtr :sources ((NextSiblingAnc :handle 0) (NotSiblingInsert
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      uint32_t hint_hi_4 =
          view_NextSiblingAnc_0_1_2_3_DELTA_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
      hint_hi_4 = (hint_hi_4 <= view_NextSiblingAnc_0_1_2_3_DELTA_VER.num_rows_)
                      ? hint_hi_4
                      : view_NextSiblingAnc_0_1_2_3_DELTA_VER.num_rows_;
      hint_hi_4 =
          (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_NextSiblingAnc_0_1_2_3_DELTA_VER.num_rows_;
      auto h_NextSiblingAnc_0_root =
          HandleType(hint_lo_3, hint_hi_4, 0)
              .prefix(root_val_2, tile, view_NextSiblingAnc_0_1_2_3_DELTA_VER);
      if (!h_NextSiblingAnc_0_root.valid())
        continue;
      auto h_NotSiblingInsert_1_root =
          HandleType(0, view_NotSiblingInsert_2_3_0_1_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_NotSiblingInsert_2_3_0_1_FULL_VER);
      if (!h_NotSiblingInsert_1_root.valid())
        continue;
      auto ParentCtr = root_val_2;
      // Nested ColumnJoin (intersection): bind 'ParentN' from 2 sources
      // MIR: (column-join :var ParentN :sources ((NextSiblingAnc :handle 2 :prefix (ParentCtr))
      // (NotSiblingInsert :handle 3 :prefix (ParentCtr)) ))
      ...
      auto intersect_10 = intersect_handles(
          tile, h_NextSiblingAnc_2_8.iterators(view_NextSiblingAnc_0_1_2_3_DELTA_VER),
          h_NotSiblingInsert_3_9.iterators(view_NotSiblingInsert_2_3_0_1_FULL_VER));
      for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
        auto ParentN = it_11.value();
        auto positions = it_11.positions();
        auto ch_NextSiblingAnc_2_ParentN = h_NextSiblingAnc_2_8.child_range(
            positions[0], ParentN, tile, view_NextSiblingAnc_0_1_2_3_DELTA_VER);
        auto ch_NotSiblingInsert_3_ParentN = h_NotSiblingInsert_3_9.child_range(
            positions[1], ParentN, tile, view_NotSiblingInsert_2_3_0_1_FULL_VER);
        // Nested CartesianJoin: bind NextCtr, NextN, StartCtr, StartN from 2 source(s)
        // MIR: (cartesian-join :vars (NextCtr NextN StartCtr StartN) :sources ((NextSiblingAnc
        // :handle 4 :prefix (ParentCtr ParentN)) (NotSiblingInsert :handle 5 :prefix (ParentCtr
        // ParentN)) ))
        ...
        if (!h_NextSiblingAnc_4_4.valid() || !h_NotSiblingInsert_5_6.valid())
          continue;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto intersect_14 = intersect_handles(
          tile, h_NextSiblingAnc_2_12.iterators(view_NextSiblingAnc_0_1_2_3_DELTA_VER),
          h_NotSiblingInsert_3_13.iterators(view_NotSiblingInsert_2_3_0_1_FULL_VER));
      for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
        auto ParentN = it_15.value();
        auto positions = it_15.positions();
        auto ch_NextSiblingAnc_2_ParentN = h_NextSiblingAnc_2_12.child_range(
            positions[0], ParentN, tile, view_NextSiblingAnc_0_1_2_3_DELTA_VER);
        auto ch_NotSiblingInsert_3_ParentN = h_NotSiblingInsert_3_13.child_range(
            positions[1], ParentN, tile, view_NotSiblingInsert_2_3_0_1_FULL_VER);
        // Nested CartesianJoin: bind NextCtr, NextN, StartCtr, StartN from 2 source(s)
        // MIR: (cartesian-join :vars (NextCtr NextN StartCtr StartN) :sources ((NextSiblingAnc
        // :handle 4 :prefix (ParentCtr ParentN)) (NotSiblingInsert :handle 5 :prefix (ParentCtr
        ...
        for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
          ...
          auto NextCtr = view_NextSiblingAnc_0_1_2_3_DELTA_VER.get_value(
              2, h_NextSiblingAnc_4_4.begin() + idx0_9);
          auto NextN = view_NextSiblingAnc_0_1_2_3_DELTA_VER.get_value(
              3, h_NextSiblingAnc_4_4.begin() + idx0_9);
          auto StartCtr = view_NotSiblingInsert_2_3_0_1_FULL_VER.get_value(
              2, h_NotSiblingInsert_5_6.begin() + idx1_10);
          auto StartN = view_NotSiblingInsert_2_3_0_1_FULL_VER.get_value(
              3, h_NotSiblingInsert_5_6.begin() + idx1_10);
...
JitRunner_NextSiblingAnc2_D0::LaunchParams JitRunner_NextSiblingAnc2_D0::setup(
  ...
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<NextSiblingAnc, FULL_VER>(db)
                                   : get_relation_by_schema<NextSiblingAnc, DELTA_VER>(db);
  ...
  auto& first_rel = (iteration == 0) ? get_relation_by_schema<NextSiblingAnc, FULL_VER>(db)
                                     : get_relation_by_schema<NextSiblingAnc, DELTA_VER>(db);
...
uint32_t JitRunner_NextSiblingAnc2_D0::scan_and_resize(DB& db, LaunchParams& p,
                                                       GPU_STREAM_T stream) {
...
void JitRunner_NextSiblingAnc2_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                      GPU_STREAM_T stream) {
