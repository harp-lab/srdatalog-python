...
JitRunner_Remove::LaunchParams JitRunner_Remove::setup(DB& db, uint32_t iteration,
                                                       GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_Remove::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                          GPU_STREAM_T stream) {
