...
struct JitRunner_Result {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      uint32_t hint_hi_4 =
          view_NextVisible_2_3_0_1_FULL_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
      hint_hi_4 = (hint_hi_4 <= view_NextVisible_2_3_0_1_FULL_VER.num_rows_)
                      ? hint_hi_4
                      : view_NextVisible_2_3_0_1_FULL_VER.num_rows_;
      hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_NextVisible_2_3_0_1_FULL_VER.num_rows_;
      auto h_NextVisible_0_root = HandleType(hint_lo_3, hint_hi_4, 0)
                                      .prefix(root_val_2, tile, view_NextVisible_2_3_0_1_FULL_VER);
      if (!h_NextVisible_0_root.valid())
        continue;
      auto h_CurrentValue_1_root = HandleType(0, view_CurrentValue_0_1_2_FULL_VER.num_rows_, 0)
                                       .prefix(root_val_2, tile, view_CurrentValue_0_1_2_FULL_VER);
      if (!h_CurrentValue_1_root.valid())
        continue;
      auto ctr2 = root_val_2;
      // Nested ColumnJoin (intersection): bind 'N2' from 2 sources
      // MIR: (column-join :var N2 :sources ((NextVisible :handle 2 :prefix (ctr2)) (CurrentValue
      // :handle 3 :prefix (ctr2)) ))
      auto h_NextVisible_2_8 = h_NextVisible_0_root;
      auto h_CurrentValue_3_9 = h_CurrentValue_1_root;
      auto intersect_10 =
          intersect_handles(tile, h_NextVisible_2_8.iterators(view_NextVisible_2_3_0_1_FULL_VER),
                            h_CurrentValue_3_9.iterators(view_CurrentValue_0_1_2_FULL_VER));
      for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
        auto N2 = it_11.value();
        auto positions = it_11.positions();
        auto ch_NextVisible_2_N2 = h_NextVisible_2_8.child_range(positions[0], N2, tile,
                                                                 view_NextVisible_2_3_0_1_FULL_VER);
        auto ch_CurrentValue_3_N2 = h_CurrentValue_3_9.child_range(
            positions[1], N2, tile, view_CurrentValue_0_1_2_FULL_VER);
        // Nested CartesianJoin: bind ctr1, _gen8, value from 2 source(s)
        // MIR: (cartesian-join :vars (ctr1 _gen8 value) :sources ((NextVisible :handle 4 :prefix
        // (ctr2 N2)) (CurrentValue :handle 5 :prefix (ctr2 N2)) ))
        ...
        if (!h_NextVisible_4_4.valid() || !h_CurrentValue_5_6.valid())
          continue;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto intersect_14 =
          intersect_handles(tile, h_NextVisible_2_12.iterators(view_NextVisible_2_3_0_1_FULL_VER),
                            h_CurrentValue_3_13.iterators(view_CurrentValue_0_1_2_FULL_VER));
      for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
        auto N2 = it_15.value();
        auto positions = it_15.positions();
        auto ch_NextVisible_2_N2 = h_NextVisible_2_12.child_range(
            positions[0], N2, tile, view_NextVisible_2_3_0_1_FULL_VER);
        auto ch_CurrentValue_3_N2 = h_CurrentValue_3_13.child_range(
            positions[1], N2, tile, view_CurrentValue_0_1_2_FULL_VER);
        // Nested CartesianJoin: bind ctr1, _gen8, value from 2 source(s)
        // MIR: (cartesian-join :vars (ctr1 _gen8 value) :sources ((NextVisible :handle 4 :prefix
        // (ctr2 N2)) (CurrentValue :handle 5 :prefix (ctr2 N2)) ))
        ...
        for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
          ...
          auto ctr1 =
              view_NextVisible_2_3_0_1_FULL_VER.get_value(2, h_NextVisible_4_4.begin() + idx0_9);
          auto _gen8 =
              view_NextVisible_2_3_0_1_FULL_VER.get_value(3, h_NextVisible_4_4.begin() + idx0_9);
          auto value =
              view_CurrentValue_0_1_2_FULL_VER.get_value(2, h_CurrentValue_5_6.begin() + idx1_10);
...
JitRunner_Result::LaunchParams JitRunner_Result::setup(DB& db, uint32_t iteration,
                                                       GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_Result::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                          GPU_STREAM_T stream) {
