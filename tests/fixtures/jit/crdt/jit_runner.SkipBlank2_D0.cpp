...
struct JitRunner_SkipBlank2_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      uint32_t hint_hi_4 =
          view_SkipBlank_0_1_2_3_DELTA_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
      hint_hi_4 = (hint_hi_4 <= view_SkipBlank_0_1_2_3_DELTA_VER.num_rows_)
                      ? hint_hi_4
                      : view_SkipBlank_0_1_2_3_DELTA_VER.num_rows_;
      hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_SkipBlank_0_1_2_3_DELTA_VER.num_rows_;
      auto h_SkipBlank_0_root = HandleType(hint_lo_3, hint_hi_4, 0)
                                    .prefix(root_val_2, tile, view_SkipBlank_0_1_2_3_DELTA_VER);
      if (!h_SkipBlank_0_root.valid())
        continue;
      auto h_NotHasValueNextElem_1_root =
          HandleType(0, view_NotHasValueNextElem_2_3_0_1_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_NotHasValueNextElem_2_3_0_1_FULL_VER);
      if (!h_NotHasValueNextElem_1_root.valid())
        continue;
      auto ViaCtr = root_val_2;
      // Nested ColumnJoin (intersection): bind 'ViaN' from 2 sources
      // MIR: (column-join :var ViaN :sources ((SkipBlank :handle 2 :prefix (ViaCtr))
      // (NotHasValueNextElem :handle 3 :prefix (ViaCtr)) ))
      ...
      auto intersect_10 = intersect_handles(
          tile, h_SkipBlank_2_8.iterators(view_SkipBlank_0_1_2_3_DELTA_VER),
          h_NotHasValueNextElem_3_9.iterators(view_NotHasValueNextElem_2_3_0_1_FULL_VER));
      for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
        auto ViaN = it_11.value();
        auto positions = it_11.positions();
        auto ch_SkipBlank_2_ViaN =
            h_SkipBlank_2_8.child_range(positions[0], ViaN, tile, view_SkipBlank_0_1_2_3_DELTA_VER);
        auto ch_NotHasValueNextElem_3_ViaN = h_NotHasValueNextElem_3_9.child_range(
            positions[1], ViaN, tile, view_NotHasValueNextElem_2_3_0_1_FULL_VER);
        // Nested CartesianJoin: bind ToCtr, ToN, FromCtr, FromN from 2 source(s)
        // MIR: (cartesian-join :vars (ToCtr ToN FromCtr FromN) :sources ((SkipBlank :handle 4
        // :prefix (ViaCtr ViaN)) (NotHasValueNextElem :handle 5 :prefix (ViaCtr ViaN)) ))
        ...
        if (!h_SkipBlank_4_4.valid() || !h_NotHasValueNextElem_5_6.valid())
          continue;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto intersect_14 = intersect_handles(
          tile, h_SkipBlank_2_12.iterators(view_SkipBlank_0_1_2_3_DELTA_VER),
          h_NotHasValueNextElem_3_13.iterators(view_NotHasValueNextElem_2_3_0_1_FULL_VER));
      for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
        auto ViaN = it_15.value();
        auto positions = it_15.positions();
        auto ch_SkipBlank_2_ViaN = h_SkipBlank_2_12.child_range(positions[0], ViaN, tile,
                                                                view_SkipBlank_0_1_2_3_DELTA_VER);
        auto ch_NotHasValueNextElem_3_ViaN = h_NotHasValueNextElem_3_13.child_range(
            positions[1], ViaN, tile, view_NotHasValueNextElem_2_3_0_1_FULL_VER);
        // Nested CartesianJoin: bind ToCtr, ToN, FromCtr, FromN from 2 source(s)
        // MIR: (cartesian-join :vars (ToCtr ToN FromCtr FromN) :sources ((SkipBlank :handle 4
        // :prefix (ViaCtr ViaN)) (NotHasValueNextElem :handle 5 :prefix (ViaCtr ViaN)) ))
        ...
        for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
          ...
          auto ToCtr =
              view_SkipBlank_0_1_2_3_DELTA_VER.get_value(2, h_SkipBlank_4_4.begin() + idx0_9);
          auto ToN =
              view_SkipBlank_0_1_2_3_DELTA_VER.get_value(3, h_SkipBlank_4_4.begin() + idx0_9);
          auto FromCtr = view_NotHasValueNextElem_2_3_0_1_FULL_VER.get_value(
              2, h_NotHasValueNextElem_5_6.begin() + idx1_10);
          auto FromN = view_NotHasValueNextElem_2_3_0_1_FULL_VER.get_value(
              3, h_NotHasValueNextElem_5_6.begin() + idx1_10);
...
JitRunner_SkipBlank2_D0::LaunchParams JitRunner_SkipBlank2_D0::setup(DB& db, uint32_t iteration,
                                                                     GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<SkipBlank, FULL_VER>(db)
                                   : get_relation_by_schema<SkipBlank, DELTA_VER>(db);
  ...
  auto& first_rel = (iteration == 0) ? get_relation_by_schema<SkipBlank, FULL_VER>(db)
                                     : get_relation_by_schema<SkipBlank, DELTA_VER>(db);
...
void JitRunner_SkipBlank2_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                 GPU_STREAM_T stream) {
