...
struct JitRunner_VA_VF_MA_VF_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          ...
          auto h_MemoryAlias_1_root = HandleType(0, view_MemoryAlias_0_1_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_MemoryAlias_0_1_FULL_VER);
        ...
        auto intersect_10 = intersect_handles(tile, h_MemoryAlias_2_8.iterators(view_MemoryAlias_0_1_FULL_VER), h_ValueFlow_3_9.iterators(view_ValueFlow_0_1_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto w = it_11.value();
          auto positions = it_11.positions();
          auto ch_MemoryAlias_2_w = h_MemoryAlias_2_8.child_range(positions[0], w, tile, view_MemoryAlias_0_1_FULL_VER);
          auto ch_ValueFlow_3_w = h_ValueFlow_3_9.child_range(positions[1], w, tile, view_ValueFlow_0_1_FULL_VER);
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        auto intersect_14 = intersect_handles(tile, h_MemoryAlias_2_12.iterators(view_MemoryAlias_0_1_FULL_VER), h_ValueFlow_3_13.iterators(view_ValueFlow_0_1_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          auto w = it_15.value();
          auto positions = it_15.positions();
          auto ch_MemoryAlias_2_w = h_MemoryAlias_2_12.child_range(positions[0], w, tile, view_MemoryAlias_0_1_FULL_VER);
...
JitRunner_VA_VF_MA_VF_D0::LaunchParams JitRunner_VA_VF_MA_VF_D0::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_VA_VF_MA_VF_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
