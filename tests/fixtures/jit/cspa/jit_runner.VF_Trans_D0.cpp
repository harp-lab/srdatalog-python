  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          ...
          uint32_t hint_hi_4 = view_ValueFlow_1_0_DELTA_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
          hint_hi_4 = (hint_hi_4 <= view_ValueFlow_1_0_DELTA_VER.num_rows_) ? hint_hi_4 : view_ValueFlow_1_0_DELTA_VER.num_rows_;
          hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_ValueFlow_1_0_DELTA_VER.num_rows_;
          auto h_ValueFlow_0_root = HandleType(hint_lo_3, hint_hi_4, 0).prefix(root_val_2, tile, view_ValueFlow_1_0_DELTA_VER);
        ...
        // MIR: (cartesian-join :vars (x y) :sources ((ValueFlow :handle 2 :prefix (z)) (ValueFlow :handle 3 :prefix (z)) ))
...
JitRunner_VF_Trans_D0::LaunchParams JitRunner_VF_Trans_D0::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_VF_Trans_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
