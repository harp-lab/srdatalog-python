// =============================================================
// JIT-Generated Complete Runner: JumpTableTargetRule
// Fully concrete - NO C++ templates/metaprogramming
// =============================================================

struct JitRunner_JumpTableTargetRule {
  // Type aliases - all concrete, resolved at Nim JIT time
  using DB = DdisasmPlan_DB_DeviceDB;
  using FirstSchema = JumpTableStart;
  using DestSchema = JumpTableTarget;
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_JumpTableStart_1_2_0_3_4_FULL_VER = views[0];
        auto view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER = views[1];

        // Root ColumnJoin (multi-source intersection): bind 'size' from 2 sources
        // Uses root_unique_values + prefix() pattern (like TMP)
        // MIR: (column-join :var size :sources ((JumpTableStart :handle 0) (RelJumpTableEntryCandidate :handle 1) ))
        // WARP MODE: 32 threads cooperatively handle one row
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          auto root_val_2 = root_unique_values[y_idx_1];

          uint32_t hint_lo_3 = y_idx_1;
          uint32_t hint_hi_4 = view_JumpTableStart_1_2_0_3_4_FULL_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
          hint_hi_4 = (hint_hi_4 <= view_JumpTableStart_1_2_0_3_4_FULL_VER.num_rows_) ? hint_hi_4 : view_JumpTableStart_1_2_0_3_4_FULL_VER.num_rows_;
          hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_JumpTableStart_1_2_0_3_4_FULL_VER.num_rows_;
          auto h_JumpTableStart_0_root = HandleType(hint_lo_3, hint_hi_4, 0).prefix(root_val_2, tile, view_JumpTableStart_1_2_0_3_4_FULL_VER);
          if (!h_JumpTableStart_0_root.valid()) continue;
          auto h_RelJumpTableEntryCandidate_1_root = HandleType(0, view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER);
          if (!h_RelJumpTableEntryCandidate_1_root.valid()) continue;
          auto size = root_val_2;
        // Nested ColumnJoin (intersection): bind 'tableStart' from 2 sources
        // MIR: (column-join :var tableStart :sources ((JumpTableStart :handle 2 :prefix (size)) (RelJumpTableEntryCandidate :handle 3 :prefix (size)) ))
        auto h_JumpTableStart_2_8 = h_JumpTableStart_0_root;
        auto h_RelJumpTableEntryCandidate_3_9 = h_RelJumpTableEntryCandidate_1_root;
        auto intersect_10 = intersect_handles(tile, h_JumpTableStart_2_8.iterators(view_JumpTableStart_1_2_0_3_4_FULL_VER), h_RelJumpTableEntryCandidate_3_9.iterators(view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto tableStart = it_11.value();
          auto positions = it_11.positions();
          auto ch_JumpTableStart_2_tableStart = h_JumpTableStart_2_8.child_range(positions[0], tableStart, tile, view_JumpTableStart_1_2_0_3_4_FULL_VER);
          auto ch_RelJumpTableEntryCandidate_3_tableStart = h_RelJumpTableEntryCandidate_3_9.child_range(positions[1], tableStart, tile, view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER);
        // Nested CartesianJoin: bind ea, _gen1, _gen2, _gen3, _gen4, dest, _gen5, _gen6 from 2 source(s)
        // MIR: (cartesian-join :vars (ea _gen1 _gen2 _gen3 _gen4 dest _gen5 _gen6) :sources ((JumpTableStart :handle 4 :prefix (size tableStart)) (RelJumpTableEntryCandidate :handle 5 :prefix (size tableStart)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();

        auto h_JumpTableStart_4_4 = ch_JumpTableStart_2_tableStart;  // reusing narrowed handle
        auto h_RelJumpTableEntryCandidate_5_6 = ch_RelJumpTableEntryCandidate_3_tableStart;  // reusing narrowed handle

        if (!h_JumpTableStart_4_4.valid() || !h_RelJumpTableEntryCandidate_5_6.valid()) continue;

        uint32_t degree_3 = h_JumpTableStart_4_4.degree();
        uint32_t degree_5 = h_RelJumpTableEntryCandidate_5_6.degree();
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        // Nested ColumnJoin (intersection): bind 'tableStart' from 2 sources
        // MIR: (column-join :var tableStart :sources ((JumpTableStart :handle 2 :prefix (size)) (RelJumpTableEntryCandidate :handle 3 :prefix (size)) ))
        auto h_JumpTableStart_2_12 = h_JumpTableStart_0_root;
        auto h_RelJumpTableEntryCandidate_3_13 = h_RelJumpTableEntryCandidate_1_root;
        auto intersect_14 = intersect_handles(tile, h_JumpTableStart_2_12.iterators(view_JumpTableStart_1_2_0_3_4_FULL_VER), h_RelJumpTableEntryCandidate_3_13.iterators(view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          auto tableStart = it_15.value();
          auto positions = it_15.positions();
          auto ch_JumpTableStart_2_tableStart = h_JumpTableStart_2_12.child_range(positions[0], tableStart, tile, view_JumpTableStart_1_2_0_3_4_FULL_VER);
          auto ch_RelJumpTableEntryCandidate_3_tableStart = h_RelJumpTableEntryCandidate_3_13.child_range(positions[1], tableStart, tile, view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER);
        // Nested CartesianJoin: bind ea, _gen1, _gen2, _gen3, _gen4, dest, _gen5, _gen6 from 2 source(s)
        // MIR: (cartesian-join :vars (ea _gen1 _gen2 _gen3 _gen4 dest _gen5 _gen6) :sources ((JumpTableStart :handle 4 :prefix (size tableStart)) (RelJumpTableEntryCandidate :handle 5 :prefix (size tableStart)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();
        ...
        for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
          ...
          auto ea = view_JumpTableStart_1_2_0_3_4_FULL_VER.get_value(2, h_JumpTableStart_4_4.begin() + idx0_9);
          auto _gen1 = view_JumpTableStart_1_2_0_3_4_FULL_VER.get_value(3, h_JumpTableStart_4_4.begin() + idx0_9);
          auto _gen2 = view_JumpTableStart_1_2_0_3_4_FULL_VER.get_value(4, h_JumpTableStart_4_4.begin() + idx0_9);
          auto _gen3 = view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER.get_value(2, h_RelJumpTableEntryCandidate_5_6.begin() + idx1_10);
          auto _gen4 = view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER.get_value(3, h_RelJumpTableEntryCandidate_5_6.begin() + idx1_10);
          auto dest = view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER.get_value(4, h_RelJumpTableEntryCandidate_5_6.begin() + idx1_10);
          auto _gen5 = view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER.get_value(5, h_RelJumpTableEntryCandidate_5_6.begin() + idx1_10);
          auto _gen6 = view_RelJumpTableEntryCandidate_2_1_0_3_4_5_6_FULL_VER.get_value(6, h_RelJumpTableEntryCandidate_5_6.begin() + idx1_10);

        // Emit: JumpTableTarget(ea, dest)
        output_ctx_0.emit_direct(ea, dest);
        }
        }
        }
  }
...
JitRunner_JumpTableTargetRule::LaunchParams JitRunner_JumpTableTargetRule::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  p.views_vec.reserve(NumSources);

  // Source 0: JumpTableStart version FULL_VER
  {
    auto& rel_0 = get_relation_by_schema<JumpTableStart, FULL_VER>(db);
    auto& idx_0 = rel_0.ensure_index(SRDatalog::IndexSpec{{1, 2, 0, 3, 4}}, false);
    p.views_vec.push_back(idx_0.view());
  }

  // Source 1: RelJumpTableEntryCandidate version FULL_VER
  {
    auto& rel_1 = get_relation_by_schema<RelJumpTableEntryCandidate, FULL_VER>(db);
    auto& idx_1 = rel_1.ensure_index(SRDatalog::IndexSpec{{2, 1, 0, 3, 4, 5, 6}}, false);
    p.views_vec.push_back(idx_1.view());
  }

  // First source for root keys
  auto& first_rel = get_relation_by_schema<JumpTableStart, FULL_VER>(db);
...
void JitRunner_JumpTableTargetRule::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_JumpTableTargetRule::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
  ...
  auto& dest_rel_0 = get_relation_by_schema<JumpTableTarget, NEW_VER>(db);
...
void JitRunner_JumpTableTargetRule::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_JumpTableTargetRule::read_total(LaunchParams& p) {
...
void JitRunner_JumpTableTargetRule::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_JumpTableTargetRule::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_JumpTableTargetRule::read_fused_result(LaunchParams& p) {
...
void JitRunner_JumpTableTargetRule::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("JumpTableTargetRule");
...
void JitRunner_JumpTableTargetRule::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
