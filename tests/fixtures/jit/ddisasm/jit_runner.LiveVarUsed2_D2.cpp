...
struct JitRunner_LiveVarUsed2_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        // Nested CartesianJoin: bind _gen14, reg, eaUsed, index, _gen12, retBlock, retBlockEnd from 2 source(s)
        // MIR: (cartesian-join :vars (_gen14 reg eaUsed index _gen12 retBlock retBlockEnd) :sources ((RegDefUseReturnValUsed :handle 2 :prefix (callee)) (RegDefUseReturnBlockEnd :handle 3 :prefix (callee)) ))
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        for (uint32_t flat_idx_9 = lane_2; flat_idx_9 < total_8; flat_idx_9 += group_size_3) {
          ...
          auto _gen14 = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(1, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
          auto reg = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(2, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
          auto eaUsed = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(3, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
          auto index = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(4, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
          auto _gen12 = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(1, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
          auto retBlock = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(2, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
          auto retBlockEnd = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(3, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
...
JitRunner_LiveVarUsed2_D2::LaunchParams JitRunner_LiveVarUsed2_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_LiveVarUsed2_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
