...
struct JitRunner_RegDefUsed3_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER = views[1];
        auto view_RegDefUseDefUsed_1_2_0_3_FULL_VER = views[3];

        // Root ColumnJoin (multi-source intersection): bind 'nxtBlk' from 2 sources
        // Uses root_unique_values + prefix() pattern (like TMP)
        // MIR: (column-join :var nxtBlk :sources ((RegDefUseLiveVarUsed :handle 0) (RegDefUseLiveVarAtPriorUsed :handle 1) ))
        // WARP MODE: 32 threads cooperatively handle one row
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          auto root_val_2 = root_unique_values[y_idx_1];

          uint32_t hint_lo_3 = y_idx_1;
          uint32_t hint_hi_4 = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
          hint_hi_4 = (hint_hi_4 <= view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_) ? hint_hi_4 : view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_;
          ...
          for (int _seg_1 = 0; _seg_1 < 2; _seg_1++) {
            ...
            view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER = view_RegDefUseLiveVarAtPriorUsed_1;
            ...
            auto nxtBlk = root_val_2;
        // Nested ColumnJoin (intersection): bind 'mvar' from 3 sources
        // MIR: (column-join :var mvar :sources ((RegDefUseLiveVarUsed :handle 2 :prefix (nxtBlk)) (RegDefUseLiveVarAtPriorUsed :handle 3 :prefix (nxtBlk)) (RegDefUseDefUsed :handle 4 :prefix ()) ))
        for (int _nseg_2 = 0; _nseg_2 < 2; _nseg_2++) {
          view_RegDefUseDefUsed_1_2_0_3_FULL_VER = views[3 + _nseg_2];
          ...
          auto h_RegDefUseDefUsed_4_14 = HandleType(0, view_RegDefUseDefUsed_1_2_0_3_FULL_VER.num_rows_, 0);
          auto intersect_15 = intersect_handles(tile, h_RegDefUseLiveVarUsed_2_12.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER), h_RegDefUseLiveVarAtPriorUsed_3_13.iterators(view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER), h_RegDefUseDefUsed_4_14.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
          for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
          auto mvar = it_16.value();
          auto positions = it_16.positions();
          auto ch_RegDefUseLiveVarUsed_2_mvar = h_RegDefUseLiveVarUsed_2_12.child_range(positions[0], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER);
          auto ch_RegDefUseLiveVarAtPriorUsed_3_mvar = h_RegDefUseLiveVarAtPriorUsed_3_13.child_range(positions[1], mvar, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
          auto ch_RegDefUseDefUsed_4_mvar = h_RegDefUseDefUsed_4_14.child_range(positions[2], mvar, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'eaUsed' from 2 sources
        // MIR: (column-join :var eaUsed :sources ((RegDefUseLiveVarAtPriorUsed :handle 5 :prefix (nxtBlk mvar)) (RegDefUseDefUsed :handle 6 :prefix (mvar)) ))
        auto h_RegDefUseLiveVarAtPriorUsed_5_8 = ch_RegDefUseLiveVarAtPriorUsed_3_mvar;
        auto h_RegDefUseDefUsed_6_9 = ch_RegDefUseDefUsed_4_mvar;
        auto intersect_10 = intersect_handles(tile, h_RegDefUseLiveVarAtPriorUsed_5_8.iterators(view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER), h_RegDefUseDefUsed_6_9.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto eaUsed = it_11.value();
          auto positions = it_11.positions();
          auto ch_RegDefUseLiveVarAtPriorUsed_5_eaUsed = h_RegDefUseLiveVarAtPriorUsed_5_8.child_range(positions[0], eaUsed, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
          auto ch_RegDefUseDefUsed_6_eaUsed = h_RegDefUseDefUsed_6_9.child_range(positions[1], eaUsed, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
        // Nested CartesianJoin: bind eaDef, nextEaUsed, nextIndex, _gen7 from 2 source(s)
        // MIR: (cartesian-join :vars (eaDef nextEaUsed nextIndex _gen7) :sources ((RegDefUseLiveVarUsed :handle 7 :prefix (nxtBlk mvar)) (RegDefUseDefUsed :handle 8 :prefix (mvar eaUsed)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();

        auto h_RegDefUseLiveVarUsed_7_4 = ch_RegDefUseLiveVarUsed_2_mvar;  // reusing narrowed handle
        auto h_RegDefUseDefUsed_8_6 = ch_RegDefUseDefUsed_6_eaUsed;  // reusing narrowed handle

        if (!h_RegDefUseLiveVarUsed_7_4.valid() || !h_RegDefUseDefUsed_8_6.valid()) continue;

        uint32_t degree_3 = h_RegDefUseLiveVarUsed_7_4.degree();
        uint32_t degree_5 = h_RegDefUseDefUsed_8_6.degree();
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        for (int _nseg_2 = 0; _nseg_2 < 2; _nseg_2++) {
          ...
          auto h_RegDefUseDefUsed_4_18 = HandleType(0, view_RegDefUseDefUsed_1_2_0_3_FULL_VER.num_rows_, 0);
          auto intersect_19 = intersect_handles(tile, h_RegDefUseLiveVarUsed_2_16.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER), h_RegDefUseLiveVarAtPriorUsed_3_17.iterators(view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER), h_RegDefUseDefUsed_4_18.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
          for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
          auto mvar = it_20.value();
          auto positions = it_20.positions();
          auto ch_RegDefUseLiveVarUsed_2_mvar = h_RegDefUseLiveVarUsed_2_16.child_range(positions[0], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER);
          auto ch_RegDefUseLiveVarAtPriorUsed_3_mvar = h_RegDefUseLiveVarAtPriorUsed_3_17.child_range(positions[1], mvar, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
          auto ch_RegDefUseDefUsed_4_mvar = h_RegDefUseDefUsed_4_18.child_range(positions[2], mvar, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'eaUsed' from 2 sources
        // MIR: (column-join :var eaUsed :sources ((RegDefUseLiveVarAtPriorUsed :handle 5 :prefix (nxtBlk mvar)) (RegDefUseDefUsed :handle 6 :prefix (mvar)) ))
        auto h_RegDefUseLiveVarAtPriorUsed_5_12 = ch_RegDefUseLiveVarAtPriorUsed_3_mvar;
        auto h_RegDefUseDefUsed_6_13 = ch_RegDefUseDefUsed_4_mvar;
        auto intersect_14 = intersect_handles(tile, h_RegDefUseLiveVarAtPriorUsed_5_12.iterators(view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER), h_RegDefUseDefUsed_6_13.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          auto eaUsed = it_15.value();
          auto positions = it_15.positions();
          auto ch_RegDefUseLiveVarAtPriorUsed_5_eaUsed = h_RegDefUseLiveVarAtPriorUsed_5_12.child_range(positions[0], eaUsed, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
          auto ch_RegDefUseDefUsed_6_eaUsed = h_RegDefUseDefUsed_6_13.child_range(positions[1], eaUsed, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
        // Nested CartesianJoin: bind eaDef, nextEaUsed, nextIndex, _gen7 from 2 source(s)
        // MIR: (cartesian-join :vars (eaDef nextEaUsed nextIndex _gen7) :sources ((RegDefUseLiveVarUsed :handle 7 :prefix (nxtBlk mvar)) (RegDefUseDefUsed :handle 8 :prefix (mvar eaUsed)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();
        ...
        for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
          ...
          auto nextEaUsed = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(2, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
          auto nextIndex = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(3, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
          auto eaDef = view_RegDefUseDefUsed_1_2_0_3_FULL_VER.get_value(2, h_RegDefUseDefUsed_8_6.begin() + idx1_10);
          auto _gen7 = view_RegDefUseDefUsed_1_2_0_3_FULL_VER.get_value(3, h_RegDefUseDefUsed_8_6.begin() + idx1_10);
...
JitRunner_RegDefUsed3_D2::LaunchParams JitRunner_RegDefUsed3_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  p.views_vec.reserve(NumSources);

  // Source 0: RegDefUseLiveVarUsed version DELTA_VER
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<RegDefUseLiveVarUsed, FULL_VER>(db) : get_relation_by_schema<RegDefUseLiveVarUsed, DELTA_VER>(db);
  ...
  // Source 4: RegDefUseDefUsed version FULL_VER
  {
    auto& rel_4 = get_relation_by_schema<RegDefUseDefUsed, FULL_VER>(db);
    auto& idx_4 = rel_4.ensure_index(SRDatalog::IndexSpec{{1, 2, 0, 3}}, false);
    p.views_vec.push_back(idx_4.full_view());
    p.views_vec.push_back(idx_4.head_view());
  }

  // First source for root keys
  auto& first_rel = (iteration == 0) ? get_relation_by_schema<RegDefUseLiveVarUsed, FULL_VER>(db) : get_relation_by_schema<RegDefUseLiveVarUsed, DELTA_VER>(db);
...
void JitRunner_RegDefUsed3_D2::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_RegDefUsed3_D2::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed3_D2::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_RegDefUsed3_D2::read_total(LaunchParams& p) {
...
void JitRunner_RegDefUsed3_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed3_D2::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed3_D2::read_fused_result(LaunchParams& p) {
...
void JitRunner_RegDefUsed3_D2::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("RegDefUsed3_D2");
...
void JitRunner_RegDefUsed3_D2::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
