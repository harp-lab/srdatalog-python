...
struct JitRunner_RegDefUsed4_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_RegDefUseBlockLastDef_2_0_1_FULL_VER = views[2];
        ...
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          ...
          uint32_t hint_hi_4 = view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
          hint_hi_4 = (hint_hi_4 <= view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.num_rows_) ? hint_hi_4 : view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.num_rows_;
          hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.num_rows_;
          auto h_RegDefUseReturnValUsed_0_root = HandleType(hint_lo_3, hint_hi_4, 0).prefix(root_val_2, tile, view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER);
          if (!h_RegDefUseReturnValUsed_0_root.valid()) continue;
          auto h_RegDefUseReturnBlockEnd_1_root = HandleType(0, view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER);
        ...
        // MIR: (column-join :var reg :sources ((RegDefUseReturnValUsed :handle 2 :prefix (callee)) (RegDefUseBlockLastDef :handle 3 :prefix ()) ))
        auto h_RegDefUseReturnValUsed_2_14 = h_RegDefUseReturnValUsed_0_root;
        auto h_RegDefUseBlockLastDef_3_15 = HandleType(0, view_RegDefUseBlockLastDef_2_0_1_FULL_VER.num_rows_, 0);
        auto intersect_16 = intersect_handles(tile, h_RegDefUseReturnValUsed_2_14.iterators(view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER), h_RegDefUseBlockLastDef_3_15.iterators(view_RegDefUseBlockLastDef_2_0_1_FULL_VER));
        for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
          auto reg = it_17.value();
          auto positions = it_17.positions();
          auto ch_RegDefUseReturnValUsed_2_reg = h_RegDefUseReturnValUsed_2_14.child_range(positions[0], reg, tile, view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER);
          auto ch_RegDefUseBlockLastDef_3_reg = h_RegDefUseBlockLastDef_3_15.child_range(positions[1], reg, tile, view_RegDefUseBlockLastDef_2_0_1_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'blockEnd' from 2 sources
        // MIR: (column-join :var blockEnd :sources ((RegDefUseReturnBlockEnd :handle 4 :prefix (callee)) (RegDefUseBlockLastDef :handle 5 :prefix (reg)) ))
        auto h_RegDefUseReturnBlockEnd_4_10 = h_RegDefUseReturnBlockEnd_1_root;
        auto h_RegDefUseBlockLastDef_5_11 = ch_RegDefUseBlockLastDef_3_reg;
        auto intersect_12 = intersect_handles(tile, h_RegDefUseReturnBlockEnd_4_10.iterators(view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER), h_RegDefUseBlockLastDef_5_11.iterators(view_RegDefUseBlockLastDef_2_0_1_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          auto blockEnd = it_13.value();
          auto positions = it_13.positions();
          auto ch_RegDefUseReturnBlockEnd_4_blockEnd = h_RegDefUseReturnBlockEnd_4_10.child_range(positions[0], blockEnd, tile, view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER);
          auto ch_RegDefUseBlockLastDef_5_blockEnd = h_RegDefUseBlockLastDef_5_11.child_range(positions[1], blockEnd, tile, view_RegDefUseBlockLastDef_2_0_1_FULL_VER);
        // Nested CartesianJoin: bind _gen8, eaUsed, index, _gen9, _gen10, eaDef from 3 source(s)
        // MIR: (cartesian-join :vars (_gen8 eaUsed index _gen9 _gen10 eaDef) :sources ((RegDefUseReturnValUsed :handle 6 :prefix (callee reg)) (RegDefUseReturnBlockEnd :handle 7 :prefix (callee blockEnd)) (RegDefUseBlockLastDef :handle 8 :prefix (reg blockEnd)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();

        auto h_RegDefUseReturnValUsed_6_4 = ch_RegDefUseReturnValUsed_2_reg;  // reusing narrowed handle
        auto h_RegDefUseReturnBlockEnd_7_6 = ch_RegDefUseReturnBlockEnd_4_blockEnd;  // reusing narrowed handle
        auto h_RegDefUseBlockLastDef_8_8 = ch_RegDefUseBlockLastDef_5_blockEnd;  // reusing narrowed handle

        if (!h_RegDefUseReturnValUsed_6_4.valid() || !h_RegDefUseReturnBlockEnd_7_6.valid() || !h_RegDefUseBlockLastDef_8_8.valid()) continue;
        ...
        {
          uint64_t cap_total = (uint64_t)degree_3 * (uint64_t)degree_5 * (uint64_t)degree_7;
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        auto h_RegDefUseBlockLastDef_3_19 = HandleType(0, view_RegDefUseBlockLastDef_2_0_1_FULL_VER.num_rows_, 0);
        auto intersect_20 = intersect_handles(tile, h_RegDefUseReturnValUsed_2_18.iterators(view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER), h_RegDefUseBlockLastDef_3_19.iterators(view_RegDefUseBlockLastDef_2_0_1_FULL_VER));
        for (auto it_21 = intersect_20.begin(); it_21.valid(); it_21.next()) {
          auto reg = it_21.value();
          auto positions = it_21.positions();
          auto ch_RegDefUseReturnValUsed_2_reg = h_RegDefUseReturnValUsed_2_18.child_range(positions[0], reg, tile, view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER);
          auto ch_RegDefUseBlockLastDef_3_reg = h_RegDefUseBlockLastDef_3_19.child_range(positions[1], reg, tile, view_RegDefUseBlockLastDef_2_0_1_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'blockEnd' from 2 sources
        // MIR: (column-join :var blockEnd :sources ((RegDefUseReturnBlockEnd :handle 4 :prefix (callee)) (RegDefUseBlockLastDef :handle 5 :prefix (reg)) ))
        ...
        auto intersect_16 = intersect_handles(tile, h_RegDefUseReturnBlockEnd_4_14.iterators(view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER), h_RegDefUseBlockLastDef_5_15.iterators(view_RegDefUseBlockLastDef_2_0_1_FULL_VER));
        for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
          auto blockEnd = it_17.value();
          auto positions = it_17.positions();
          auto ch_RegDefUseReturnBlockEnd_4_blockEnd = h_RegDefUseReturnBlockEnd_4_14.child_range(positions[0], blockEnd, tile, view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER);
          auto ch_RegDefUseBlockLastDef_5_blockEnd = h_RegDefUseBlockLastDef_5_15.child_range(positions[1], blockEnd, tile, view_RegDefUseBlockLastDef_2_0_1_FULL_VER);
        // Nested CartesianJoin: bind _gen8, eaUsed, index, _gen9, _gen10, eaDef from 3 source(s)
        // MIR: (cartesian-join :vars (_gen8 eaUsed index _gen9 _gen10 eaDef) :sources ((RegDefUseReturnValUsed :handle 6 :prefix (callee reg)) (RegDefUseReturnBlockEnd :handle 7 :prefix (callee blockEnd)) (RegDefUseBlockLastDef :handle 8 :prefix (reg blockEnd)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();
        ...
        for (uint32_t flat_idx_10 = lane_1; flat_idx_10 < total_9; flat_idx_10 += group_size_2) {
          ...
          auto _gen8 = view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.get_value(2, h_RegDefUseReturnValUsed_6_4.begin() + idx0_11);
          auto eaUsed = view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.get_value(3, h_RegDefUseReturnValUsed_6_4.begin() + idx0_11);
          auto index = view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.get_value(4, h_RegDefUseReturnValUsed_6_4.begin() + idx0_11);
          auto _gen9 = view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER.get_value(2, h_RegDefUseReturnBlockEnd_7_6.begin() + idx1_12);
          auto _gen10 = view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER.get_value(3, h_RegDefUseReturnBlockEnd_7_6.begin() + idx1_12);
          auto eaDef = view_RegDefUseBlockLastDef_2_0_1_FULL_VER.get_value(2, h_RegDefUseBlockLastDef_8_8.begin() + idx2_13);

        // Emit: RegDefUseDefUsed(eaDef, reg, eaUsed, index)
        output_ctx_0.emit_direct(eaDef, reg, eaUsed, index);
        }
        }
        }
        }
...
JitRunner_RegDefUsed4_D0::LaunchParams JitRunner_RegDefUsed4_D0::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  p.views_vec.reserve(NumSources);

  // Source 0: RegDefUseReturnValUsed version DELTA_VER
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<RegDefUseReturnValUsed, FULL_VER>(db) : get_relation_by_schema<RegDefUseReturnValUsed, DELTA_VER>(db);
    auto& idx_0 = rel_0.ensure_index(SRDatalog::IndexSpec{{1, 2, 0, 3, 4}}, false);
    p.views_vec.push_back(idx_0.view());
  }

  // Source 1: RegDefUseReturnBlockEnd version FULL_VER
  {
    auto& rel_1 = get_relation_by_schema<RegDefUseReturnBlockEnd, FULL_VER>(db);
    auto& idx_1 = rel_1.ensure_index(SRDatalog::IndexSpec{{0, 3, 1, 2}}, false);
    p.views_vec.push_back(idx_1.view());
  }

  // Source 3: RegDefUseBlockLastDef version FULL_VER
  {
    auto& rel_3 = get_relation_by_schema<RegDefUseBlockLastDef, FULL_VER>(db);
    auto& idx_3 = rel_3.ensure_index(SRDatalog::IndexSpec{{2, 0, 1}}, false);
    p.views_vec.push_back(idx_3.view());
  }

  // First source for root keys
  auto& first_rel = (iteration == 0) ? get_relation_by_schema<RegDefUseReturnValUsed, FULL_VER>(db) : get_relation_by_schema<RegDefUseReturnValUsed, DELTA_VER>(db);
  auto& first_idx = first_rel.get_index(SRDatalog::IndexSpec{{1, 2, 0, 3, 4}});
...
void JitRunner_RegDefUsed4_D0::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_RegDefUsed4_D0::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed4_D0::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_RegDefUsed4_D0::read_total(LaunchParams& p) {
...
void JitRunner_RegDefUsed4_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed4_D0::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed4_D0::read_fused_result(LaunchParams& p) {
...
void JitRunner_RegDefUsed4_D0::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("RegDefUsed4_D0");
...
void JitRunner_RegDefUsed4_D0::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
