...
struct JitRunner_RegRegArithDefs {
  ...
  static constexpr std::size_t OutputArity_0 = 8;
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_DefUsedForAddress_0_1_2_FULL_VER = views[0];
        auto view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER = views[1];
        auto view_RegDefUseDefUsed_2_1_0_3_FULL_VER = views[2];

        // Root ColumnJoin (multi-source intersection): bind 'ea' from 4 sources
        // Uses root_unique_values + prefix() pattern (like TMP)
        // MIR: (column-join :var ea :sources ((DefUsedForAddress :handle 0) (ArchRegRegArithOp :handle 1) (RegDefUseDefUsed :handle 2) (RegDefUseDefUsed :handle 3) ))
        // WARP MODE: 32 threads cooperatively handle one row
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          auto root_val_2 = root_unique_values[y_idx_1];

          uint32_t hint_lo_3 = y_idx_1;
          uint32_t hint_hi_4 = view_DefUsedForAddress_0_1_2_FULL_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
          hint_hi_4 = (hint_hi_4 <= view_DefUsedForAddress_0_1_2_FULL_VER.num_rows_) ? hint_hi_4 : view_DefUsedForAddress_0_1_2_FULL_VER.num_rows_;
          hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_DefUsedForAddress_0_1_2_FULL_VER.num_rows_;
          auto h_DefUsedForAddress_0_root = HandleType(hint_lo_3, hint_hi_4, 0).prefix(root_val_2, tile, view_DefUsedForAddress_0_1_2_FULL_VER);
          if (!h_DefUsedForAddress_0_root.valid()) continue;
          auto h_ArchRegRegArithOp_1_root = HandleType(0, view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER);
          if (!h_ArchRegRegArithOp_1_root.valid()) continue;
          // Segment loop: RegDefUseDefUsed FULL_VER has 2 segments (FULL + HEAD)
          for (int _seg_2 = 0; _seg_2 < 2; _seg_2++) {
            auto view_RegDefUseDefUsed_2 = views[2 + _seg_2];
            view_RegDefUseDefUsed_2_1_0_3_FULL_VER = view_RegDefUseDefUsed_2;
            auto h_RegDefUseDefUsed_2_root = HandleType(0, view_RegDefUseDefUsed_2.num_rows_, 0).prefix(root_val_2, tile, view_RegDefUseDefUsed_2);
            if (!h_RegDefUseDefUsed_2_root.valid()) continue;
            // Segment loop: RegDefUseDefUsed FULL_VER has 2 segments (FULL + HEAD)
            for (int _seg_3 = 0; _seg_3 < 2; _seg_3++) {
              auto view_RegDefUseDefUsed_3 = views[2 + _seg_3];
              view_RegDefUseDefUsed_2_1_0_3_FULL_VER = view_RegDefUseDefUsed_3;
              auto h_RegDefUseDefUsed_3_root = HandleType(0, view_RegDefUseDefUsed_3.num_rows_, 0).prefix(root_val_2, tile, view_RegDefUseDefUsed_3);
              if (!h_RegDefUseDefUsed_3_root.valid()) continue;
              auto ea = root_val_2;
        // Nested ColumnJoin (intersection): bind 'regDef' from 2 sources
        // MIR: (column-join :var regDef :sources ((DefUsedForAddress :handle 4 :prefix (ea)) (ArchRegRegArithOp :handle 5 :prefix (ea)) ))
        auto h_DefUsedForAddress_4_25 = h_DefUsedForAddress_0_root;
        auto h_ArchRegRegArithOp_5_26 = h_ArchRegRegArithOp_1_root;
        auto intersect_27 = intersect_handles(tile, h_DefUsedForAddress_4_25.iterators(view_DefUsedForAddress_0_1_2_FULL_VER), h_ArchRegRegArithOp_5_26.iterators(view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER));
        for (auto it_28 = intersect_27.begin(); it_28.valid(); it_28.next()) {
          auto regDef = it_28.value();
          auto positions = it_28.positions();
          auto ch_DefUsedForAddress_4_regDef = h_DefUsedForAddress_4_25.child_range(positions[0], regDef, tile, view_DefUsedForAddress_0_1_2_FULL_VER);
          auto ch_ArchRegRegArithOp_5_regDef = h_ArchRegRegArithOp_5_26.child_range(positions[1], regDef, tile, view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'reg1' from 2 sources
        // MIR: (column-join :var reg1 :sources ((ArchRegRegArithOp :handle 6 :prefix (ea regDef)) (RegDefUseDefUsed :handle 7 :prefix (ea)) ))
        auto h_ArchRegRegArithOp_6_21 = ch_ArchRegRegArithOp_5_regDef;
        auto h_RegDefUseDefUsed_7_22 = h_RegDefUseDefUsed_3_root;
        auto intersect_23 = intersect_handles(tile, h_ArchRegRegArithOp_6_21.iterators(view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER), h_RegDefUseDefUsed_7_22.iterators(view_RegDefUseDefUsed_2_1_0_3_FULL_VER));
        for (auto it_24 = intersect_23.begin(); it_24.valid(); it_24.next()) {
          auto reg1 = it_24.value();
          auto positions = it_24.positions();
          auto ch_ArchRegRegArithOp_6_reg1 = h_ArchRegRegArithOp_6_21.child_range(positions[0], reg1, tile, view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER);
          auto ch_RegDefUseDefUsed_7_reg1 = h_RegDefUseDefUsed_7_22.child_range(positions[1], reg1, tile, view_RegDefUseDefUsed_2_1_0_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'reg2' from 2 sources
        // MIR: (column-join :var reg2 :sources ((ArchRegRegArithOp :handle 8 :prefix (ea regDef reg1)) (RegDefUseDefUsed :handle 9 :prefix (ea)) ))
        auto h_ArchRegRegArithOp_8_17 = ch_ArchRegRegArithOp_6_reg1;
        auto h_RegDefUseDefUsed_9_18 = h_RegDefUseDefUsed_3_root;
        auto intersect_19 = intersect_handles(tile, h_ArchRegRegArithOp_8_17.iterators(view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER), h_RegDefUseDefUsed_9_18.iterators(view_RegDefUseDefUsed_2_1_0_3_FULL_VER));
        for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
          auto reg2 = it_20.value();
          auto positions = it_20.positions();
          auto ch_ArchRegRegArithOp_8_reg2 = h_ArchRegRegArithOp_8_17.child_range(positions[0], reg2, tile, view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER);
          auto ch_RegDefUseDefUsed_9_reg2 = h_RegDefUseDefUsed_9_18.child_range(positions[1], reg2, tile, view_RegDefUseDefUsed_2_1_0_3_FULL_VER);
        // Nested CartesianJoin: bind _gen20, mult, offset, eaDef1, _gen21, eaDef2, _gen22 from 4 source(s)
        // MIR: (cartesian-join :vars (_gen20 mult offset eaDef1 _gen21 eaDef2 _gen22) :sources ((DefUsedForAddress :handle 10 :prefix (ea regDef)) (ArchRegRegArithOp :handle 11 :prefix (ea regDef reg1 reg2)) (RegDefUseDefUsed :handle 12 :prefix (ea reg1)) (RegDefUseDefUsed :handle 13 :prefix (ea reg2)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();

        auto h_DefUsedForAddress_10_4 = ch_DefUsedForAddress_4_regDef;  // reusing narrowed handle
        auto h_ArchRegRegArithOp_11_6 = ch_ArchRegRegArithOp_8_reg2;  // reusing narrowed handle
        auto h_RegDefUseDefUsed_12_8 = ch_RegDefUseDefUsed_7_reg1;  // reusing narrowed handle
        auto h_RegDefUseDefUsed_13_10 = ch_RegDefUseDefUsed_9_reg2;  // reusing narrowed handle

        if (!h_DefUsedForAddress_10_4.valid() || !h_ArchRegRegArithOp_11_6.valid() || !h_RegDefUseDefUsed_12_8.valid() || !h_RegDefUseDefUsed_13_10.valid()) continue;

        uint32_t degree_3 = h_DefUsedForAddress_10_4.degree();
        uint32_t degree_5 = h_ArchRegRegArithOp_11_6.degree();
        uint32_t degree_7 = h_RegDefUseDefUsed_12_8.degree();
        uint32_t degree_9 = h_RegDefUseDefUsed_13_10.degree();
        ...
        for (uint32_t flat_idx_12 = lane_1; flat_idx_12 < total_11; flat_idx_12 += group_size_2) {
          ...
          auto mult = view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER.get_value(4, h_ArchRegRegArithOp_11_6.begin() + idx1_14);
          auto offset = view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER.get_value(5, h_ArchRegRegArithOp_11_6.begin() + idx1_14);
          auto eaDef1 = view_RegDefUseDefUsed_2_1_0_3_FULL_VER.get_value(2, h_RegDefUseDefUsed_12_8.begin() + idx2_15);
          auto eaDef2 = view_RegDefUseDefUsed_2_1_0_3_FULL_VER.get_value(2, h_RegDefUseDefUsed_13_10.begin() + idx3_16);

        if (reg1 != reg2) {
        if (ea != eaDef1) {
        if (ea != eaDef2) {
        // Emit: RegRegArithOpDefs(ea, regDef, eaDef1, reg1, eaDef2, reg2, mult, offset)
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        for (uint32_t flat_idx_12 = lane_1; flat_idx_12 < total_11; flat_idx_12 += group_size_2) {
          ...
          auto _gen20 = view_DefUsedForAddress_0_1_2_FULL_VER.get_value(2, h_DefUsedForAddress_10_4.begin() + idx0_13);
          auto mult = view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER.get_value(4, h_ArchRegRegArithOp_11_6.begin() + idx1_14);
          auto offset = view_ArchRegRegArithOp_0_1_2_3_4_5_FULL_VER.get_value(5, h_ArchRegRegArithOp_11_6.begin() + idx1_14);
          auto eaDef1 = view_RegDefUseDefUsed_2_1_0_3_FULL_VER.get_value(2, h_RegDefUseDefUsed_12_8.begin() + idx2_15);
          auto _gen21 = view_RegDefUseDefUsed_2_1_0_3_FULL_VER.get_value(3, h_RegDefUseDefUsed_12_8.begin() + idx2_15);
          auto eaDef2 = view_RegDefUseDefUsed_2_1_0_3_FULL_VER.get_value(2, h_RegDefUseDefUsed_13_10.begin() + idx3_16);
          auto _gen22 = view_RegDefUseDefUsed_2_1_0_3_FULL_VER.get_value(3, h_RegDefUseDefUsed_13_10.begin() + idx3_16);

        if (reg1 != reg2) {
        if (ea != eaDef1) {
        if (ea != eaDef2) {
        // Emit: RegRegArithOpDefs(ea, regDef, eaDef1, reg1, eaDef2, reg2, mult, offset)
        output_ctx_0.emit_direct(ea, regDef, eaDef1, reg1, eaDef2, reg2, mult, offset);
        }
        }
        }
        }
...
JitRunner_RegRegArithDefs::LaunchParams JitRunner_RegRegArithDefs::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  p.views_vec.reserve(NumSources);

  // Source 0: DefUsedForAddress version FULL_VER
  {
    auto& rel_0 = get_relation_by_schema<DefUsedForAddress, FULL_VER>(db);
    auto& idx_0 = rel_0.ensure_index(SRDatalog::IndexSpec{{0, 1, 2}}, false);
    p.views_vec.push_back(idx_0.view());
  }

  // Source 1: ArchRegRegArithOp version FULL_VER
  {
    auto& rel_1 = get_relation_by_schema<ArchRegRegArithOp, FULL_VER>(db);
    auto& idx_1 = rel_1.ensure_index(SRDatalog::IndexSpec{{0, 1, 2, 3, 4, 5}}, false);
    p.views_vec.push_back(idx_1.view());
  }

  // Source 2: RegDefUseDefUsed version FULL_VER
  {
    auto& rel_2 = get_relation_by_schema<RegDefUseDefUsed, FULL_VER>(db);
    auto& idx_2 = rel_2.ensure_index(SRDatalog::IndexSpec{{2, 1, 0, 3}}, false);
    p.views_vec.push_back(idx_2.full_view());
    p.views_vec.push_back(idx_2.head_view());
  }

  // First source for root keys
  auto& first_rel = get_relation_by_schema<DefUsedForAddress, FULL_VER>(db);
...
void JitRunner_RegRegArithDefs::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_RegRegArithDefs::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
  ...
  auto& dest_rel_0 = get_relation_by_schema<RegRegArithOpDefs, NEW_VER>(db);
...
void JitRunner_RegRegArithDefs::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_RegRegArithDefs::read_total(LaunchParams& p) {
...
void JitRunner_RegRegArithDefs::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_RegRegArithDefs::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegRegArithDefs::read_fused_result(LaunchParams& p) {
...
void JitRunner_RegRegArithDefs::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("RegRegArithDefs");
...
void JitRunner_RegRegArithDefs::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
