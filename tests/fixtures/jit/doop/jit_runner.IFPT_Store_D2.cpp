// =============================================================
// JIT-Generated Complete Runner: IFPT_Store_D2
// Fully concrete - NO C++ templates/metaprogramming
// =============================================================

struct JitRunner_IFPT_Store_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_StoreInstanceField_0_3_1_2_FULL_VER = views[1];
        ...
        // MIR: (column-join :var frm :sources ((VarPointsTo :handle 0) (StoreInstanceField :handle 1) ))
        ...
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          ...
          auto h_StoreInstanceField_1_root = HandleType(0, view_StoreInstanceField_0_3_1_2_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_StoreInstanceField_0_3_1_2_FULL_VER);
          if (!h_StoreInstanceField_1_root.valid()) continue;
          auto frm = root_val_2;
        // Nested ColumnJoin (intersection): bind 'inmeth' from 2 sources
        // MIR: (column-join :var inmeth :sources ((StoreInstanceField :handle 2 :prefix (frm)) (Reachable :handle 3 :prefix ()) ))
        ...
        auto intersect_16 = intersect_handles(tile, h_StoreInstanceField_2_14.iterators(view_StoreInstanceField_0_3_1_2_FULL_VER), h_Reachable_3_15.iterators(view_Reachable_0_FULL_VER));
        for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
          auto inmeth = it_17.value();
          auto positions = it_17.positions();
          auto ch_StoreInstanceField_2_inmeth = h_StoreInstanceField_2_14.child_range(positions[0], inmeth, tile, view_StoreInstanceField_0_3_1_2_FULL_VER);
        ...
        // MIR: (column-join :var base :sources ((StoreInstanceField :handle 4 :prefix (frm inmeth)) (VarPointsTo :handle 5 :prefix ()) ))
        for (int _nseg_1 = 0; _nseg_1 < 2; _nseg_1++) {
          ...
          auto intersect_12 = intersect_handles(tile, h_StoreInstanceField_4_10.iterators(view_StoreInstanceField_0_3_1_2_FULL_VER), h_VarPointsTo_5_11.iterators(view_VarPointsTo_1_0_FULL_VER));
          for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          auto base = it_13.value();
          auto positions = it_13.positions();
          auto ch_StoreInstanceField_4_base = h_StoreInstanceField_4_10.child_range(positions[0], base, tile, view_StoreInstanceField_0_3_1_2_FULL_VER);
          auto ch_VarPointsTo_5_base = h_VarPointsTo_5_11.child_range(positions[1], base, tile, view_VarPointsTo_1_0_FULL_VER);
        // Nested CartesianJoin: bind heap, fld, baseheap from 3 source(s)
        // MIR: (cartesian-join :vars (heap fld baseheap) :sources ((VarPointsTo :handle 6 :prefix (frm)) (StoreInstanceField :handle 7 :prefix (frm inmeth base)) (VarPointsTo :handle 8 :prefix (base)) ))
        ...
        auto h_StoreInstanceField_7_6 = ch_StoreInstanceField_4_base;  // reusing narrowed handle
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        auto intersect_20 = intersect_handles(tile, h_StoreInstanceField_2_18.iterators(view_StoreInstanceField_0_3_1_2_FULL_VER), h_Reachable_3_19.iterators(view_Reachable_0_FULL_VER));
        for (auto it_21 = intersect_20.begin(); it_21.valid(); it_21.next()) {
          auto inmeth = it_21.value();
          auto positions = it_21.positions();
          auto ch_StoreInstanceField_2_inmeth = h_StoreInstanceField_2_18.child_range(positions[0], inmeth, tile, view_StoreInstanceField_0_3_1_2_FULL_VER);
        ...
        for (int _nseg_1 = 0; _nseg_1 < 2; _nseg_1++) {
          ...
          auto intersect_16 = intersect_handles(tile, h_StoreInstanceField_4_14.iterators(view_StoreInstanceField_0_3_1_2_FULL_VER), h_VarPointsTo_5_15.iterators(view_VarPointsTo_1_0_FULL_VER));
          for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
          auto base = it_17.value();
          auto positions = it_17.positions();
          auto ch_StoreInstanceField_4_base = h_StoreInstanceField_4_14.child_range(positions[0], base, tile, view_StoreInstanceField_0_3_1_2_FULL_VER);
        ...
        for (uint32_t flat_idx_10 = lane_1; flat_idx_10 < total_9; flat_idx_10 += group_size_2) {
          ...
          auto heap = view_VarPointsTo_1_0_DELTA_VER.get_value(1, h_VarPointsTo_6_4.begin() + idx0_11);
          auto fld = view_StoreInstanceField_0_3_1_2_FULL_VER.get_value(3, h_StoreInstanceField_7_6.begin() + idx1_12);
...
JitRunner_IFPT_Store_D2::LaunchParams JitRunner_IFPT_Store_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_IFPT_Store_D2::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_IFPT_Store_D2::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_IFPT_Store_D2::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_IFPT_Store_D2::read_total(LaunchParams& p) {
...
void JitRunner_IFPT_Store_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_IFPT_Store_D2::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_IFPT_Store_D2::read_fused_result(LaunchParams& p) {
...
void JitRunner_IFPT_Store_D2::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("IFPT_Store_D2");
...
void JitRunner_IFPT_Store_D2::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
