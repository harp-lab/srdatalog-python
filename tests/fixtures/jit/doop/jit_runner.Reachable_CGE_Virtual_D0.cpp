...
struct JitRunner_Reachable_CGE_Virtual_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        // MIR: (column-join :var simplename :sources ((VirtualMethodInvocation :handle 4 :prefix (invocation base)) (HeapHelperNoThis :handle 5 :prefix ()) ))
        auto h_VirtualMethodInvocation_4_14 = ch_VirtualMethodInvocation_2_base;
        auto h_HeapHelperNoThis_5_15 = HandleType(0, view_HeapHelperNoThis_0_1_3_2_FULL_VER.num_rows_, 0);
        auto intersect_16 = intersect_handles(tile, h_VirtualMethodInvocation_4_14.iterators(view_VirtualMethodInvocation_0_1_2_3_FULL_VER), h_HeapHelperNoThis_5_15.iterators(view_HeapHelperNoThis_0_1_3_2_FULL_VER));
        for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
          ...
          auto ch_HeapHelperNoThis_5_simplename = h_HeapHelperNoThis_5_15.child_range(positions[1], simplename, tile, view_HeapHelperNoThis_0_1_3_2_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'descriptor' from 2 sources
        // MIR: (column-join :var descriptor :sources ((VirtualMethodInvocation :handle 6 :prefix (invocation base simplename)) (HeapHelperNoThis :handle 7 :prefix (simplename)) ))
        auto h_VirtualMethodInvocation_6_10 = ch_VirtualMethodInvocation_4_simplename;
        auto h_HeapHelperNoThis_7_11 = ch_HeapHelperNoThis_5_simplename;
        auto intersect_12 = intersect_handles(tile, h_VirtualMethodInvocation_6_10.iterators(view_VirtualMethodInvocation_0_1_2_3_FULL_VER), h_HeapHelperNoThis_7_11.iterators(view_HeapHelperNoThis_0_1_3_2_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          ...
          auto ch_HeapHelperNoThis_7_descriptor = h_HeapHelperNoThis_7_11.child_range(positions[1], descriptor, tile, view_HeapHelperNoThis_0_1_3_2_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'heap' from 2 sources
        // MIR: (column-join :var heap :sources ((HeapHelperNoThis :handle 8 :prefix (simplename descriptor)) (VarPointsTo :handle 9 :prefix (base)) ))
        auto h_HeapHelperNoThis_8_6 = ch_HeapHelperNoThis_7_descriptor;
        auto h_VarPointsTo_9_7 = ch_VarPointsTo_3_base;
        auto intersect_8 = intersect_handles(tile, h_HeapHelperNoThis_8_6.iterators(view_HeapHelperNoThis_0_1_3_2_FULL_VER), h_VarPointsTo_9_7.iterators(view_VarPointsTo_1_0_FULL_VER));
        for (auto it_9 = intersect_8.begin(); it_9.valid(); it_9.next()) {
          auto heap = it_9.value();
          auto positions = it_9.positions();
          auto ch_HeapHelperNoThis_8_heap = h_HeapHelperNoThis_8_6.child_range(positions[0], heap, tile, view_HeapHelperNoThis_0_1_3_2_FULL_VER);
        ...
        // MIR: (cartesian-join :vars (toMeth) :sources ((HeapHelperNoThis :handle 10 :prefix (simplename descriptor heap)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();

        auto h_HeapHelperNoThis_10_4 = ch_HeapHelperNoThis_8_heap;  // reusing narrowed handle
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_1 output_ctx_1{output_data_1, output_prov_1, output_stride_1, old_size_1 + thread_offset};
        ...
        auto h_HeapHelperNoThis_5_17 = HandleType(0, view_HeapHelperNoThis_0_1_3_2_FULL_VER.num_rows_, 0);
        auto intersect_18 = intersect_handles(tile, h_VirtualMethodInvocation_4_16.iterators(view_VirtualMethodInvocation_0_1_2_3_FULL_VER), h_HeapHelperNoThis_5_17.iterators(view_HeapHelperNoThis_0_1_3_2_FULL_VER));
        for (auto it_19 = intersect_18.begin(); it_19.valid(); it_19.next()) {
          ...
          auto ch_HeapHelperNoThis_5_simplename = h_HeapHelperNoThis_5_17.child_range(positions[1], simplename, tile, view_HeapHelperNoThis_0_1_3_2_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'descriptor' from 2 sources
        // MIR: (column-join :var descriptor :sources ((VirtualMethodInvocation :handle 6 :prefix (invocation base simplename)) (HeapHelperNoThis :handle 7 :prefix (simplename)) ))
        auto h_VirtualMethodInvocation_6_12 = ch_VirtualMethodInvocation_4_simplename;
        auto h_HeapHelperNoThis_7_13 = ch_HeapHelperNoThis_5_simplename;
        auto intersect_14 = intersect_handles(tile, h_VirtualMethodInvocation_6_12.iterators(view_VirtualMethodInvocation_0_1_2_3_FULL_VER), h_HeapHelperNoThis_7_13.iterators(view_HeapHelperNoThis_0_1_3_2_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          ...
          auto ch_HeapHelperNoThis_7_descriptor = h_HeapHelperNoThis_7_13.child_range(positions[1], descriptor, tile, view_HeapHelperNoThis_0_1_3_2_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'heap' from 2 sources
        // MIR: (column-join :var heap :sources ((HeapHelperNoThis :handle 8 :prefix (simplename descriptor)) (VarPointsTo :handle 9 :prefix (base)) ))
        auto h_HeapHelperNoThis_8_8 = ch_HeapHelperNoThis_7_descriptor;
        auto h_VarPointsTo_9_9 = ch_VarPointsTo_3_base;
        auto intersect_10 = intersect_handles(tile, h_HeapHelperNoThis_8_8.iterators(view_HeapHelperNoThis_0_1_3_2_FULL_VER), h_VarPointsTo_9_9.iterators(view_VarPointsTo_1_0_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto heap = it_11.value();
          auto positions = it_11.positions();
          auto ch_HeapHelperNoThis_8_heap = h_HeapHelperNoThis_8_8.child_range(positions[0], heap, tile, view_HeapHelperNoThis_0_1_3_2_FULL_VER);
        ...
        for (uint32_t flat_idx_6 = lane_1; flat_idx_6 < total_5; flat_idx_6 += group_size_2) {
          ...
          auto toMeth = view_HeapHelperNoThis_0_1_3_2_FULL_VER.get_value(3, h_HeapHelperNoThis_10_4.begin() + idx0_7);

        // Emit: Reachable(toMeth)
        output_ctx_0.emit_direct(toMeth);
...
JitRunner_Reachable_CGE_Virtual_D0::LaunchParams JitRunner_Reachable_CGE_Virtual_D0::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  {
    auto& rel_5 = get_relation_by_schema<HeapHelperNoThis, FULL_VER>(db);
    auto& idx_5 = rel_5.ensure_index(SRDatalog::IndexSpec{{0, 1, 3, 2}}, false);
...
void JitRunner_Reachable_CGE_Virtual_D0::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_Reachable_CGE_Virtual_D0::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
  ...
  auto& dest_rel_0 = get_relation_by_schema<Reachable, NEW_VER>(db);
...
void JitRunner_Reachable_CGE_Virtual_D0::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_Reachable_CGE_Virtual_D0::read_total(LaunchParams& p) {
...
void JitRunner_Reachable_CGE_Virtual_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_Reachable_CGE_Virtual_D0::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_Reachable_CGE_Virtual_D0::read_fused_result(LaunchParams& p) {
...
void JitRunner_Reachable_CGE_Virtual_D0::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("Reachable_CGE_Virtual_D0");
...
void JitRunner_Reachable_CGE_Virtual_D0::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
