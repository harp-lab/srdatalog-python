// =============================================================
// JIT-Generated Complete Runner: Reachable_CGE_Virtual_D2
// Fully concrete - NO C++ templates/metaprogramming
// =============================================================

struct JitRunner_Reachable_CGE_Virtual_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_HeapHelperNoThis_3_0_1_2_FULL_VER = views[2];
        ...
        auto h_HeapHelperNoThis_3_19 = HandleType(0, view_HeapHelperNoThis_3_0_1_2_FULL_VER.num_rows_, 0);
        auto intersect_20 = intersect_handles(tile, h_VarPointsTo_2_18.iterators(view_VarPointsTo_1_0_DELTA_VER), h_HeapHelperNoThis_3_19.iterators(view_HeapHelperNoThis_3_0_1_2_FULL_VER));
        for (auto it_21 = intersect_20.begin(); it_21.valid(); it_21.next()) {
          ...
          auto ch_HeapHelperNoThis_3_heap = h_HeapHelperNoThis_3_19.child_range(positions[1], heap, tile, view_HeapHelperNoThis_3_0_1_2_FULL_VER);
        ...
        auto h_HeapHelperNoThis_7_11 = ch_HeapHelperNoThis_3_heap;
        auto intersect_12 = intersect_handles(tile, h_VirtualMethodInvocation_6_10.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_HeapHelperNoThis_7_11.iterators(view_HeapHelperNoThis_3_0_1_2_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          ...
          auto ch_HeapHelperNoThis_7_simplename = h_HeapHelperNoThis_7_11.child_range(positions[1], simplename, tile, view_HeapHelperNoThis_3_0_1_2_FULL_VER);
        ...
        auto h_HeapHelperNoThis_9_7 = ch_HeapHelperNoThis_7_simplename;
        auto intersect_8 = intersect_handles(tile, h_VirtualMethodInvocation_8_6.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_HeapHelperNoThis_9_7.iterators(view_HeapHelperNoThis_3_0_1_2_FULL_VER));
        for (auto it_9 = intersect_8.begin(); it_9.valid(); it_9.next()) {
          ...
          auto ch_HeapHelperNoThis_9_descriptor = h_HeapHelperNoThis_9_7.child_range(positions[1], descriptor, tile, view_HeapHelperNoThis_3_0_1_2_FULL_VER);
...
JitRunner_Reachable_CGE_Virtual_D2::LaunchParams JitRunner_Reachable_CGE_Virtual_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  // Source 3: HeapHelperNoThis version FULL_VER
  {
    auto& rel_3 = get_relation_by_schema<HeapHelperNoThis, FULL_VER>(db);
    auto& idx_3 = rel_3.ensure_index(SRDatalog::IndexSpec{{3, 0, 1, 2}}, false);
...
void JitRunner_Reachable_CGE_Virtual_D2::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_Reachable_CGE_Virtual_D2::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_Reachable_CGE_Virtual_D2::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_Reachable_CGE_Virtual_D2::read_total(LaunchParams& p) {
...
void JitRunner_Reachable_CGE_Virtual_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_Reachable_CGE_Virtual_D2::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_Reachable_CGE_Virtual_D2::read_fused_result(LaunchParams& p) {
...
void JitRunner_Reachable_CGE_Virtual_D2::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("Reachable_CGE_Virtual_D2");
  ...
  auto& bg_dest_0 = get_relation_by_schema<Reachable, NEW_VER>(db);
