// =============================================================
// JIT-Generated Complete Runner: VirtualDispatch_MultiHead_D2
// Fully concrete - NO C++ templates/metaprogramming
// =============================================================

struct JitRunner_VirtualDispatch_MultiHead_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_HeapHelper_4_0_1_2_3_FULL_VER = views[2];
        auto view_ReachableInstruction_0_FULL_VER = views[3];
        ...
        // MIR: (column-join :var heap :sources ((VarPointsTo :handle 2 :prefix (base)) (HeapHelper :handle 3 :prefix ()) ))
        auto h_VarPointsTo_2_18 = h_VarPointsTo_0_root;
        auto h_HeapHelper_3_19 = HandleType(0, view_HeapHelper_4_0_1_2_3_FULL_VER.num_rows_, 0);
        auto intersect_20 = intersect_handles(tile, h_VarPointsTo_2_18.iterators(view_VarPointsTo_1_0_DELTA_VER), h_HeapHelper_3_19.iterators(view_HeapHelper_4_0_1_2_3_FULL_VER));
        for (auto it_21 = intersect_20.begin(); it_21.valid(); it_21.next()) {
          auto heap = it_21.value();
          auto positions = it_21.positions();
          auto ch_VarPointsTo_2_heap = h_VarPointsTo_2_18.child_range(positions[0], heap, tile, view_VarPointsTo_1_0_DELTA_VER);
          auto ch_HeapHelper_3_heap = h_HeapHelper_3_19.child_range(positions[1], heap, tile, view_HeapHelper_4_0_1_2_3_FULL_VER);
        ...
        auto h_VirtualMethodInvocation_4_14 = h_VirtualMethodInvocation_1_root;
        auto h_ReachableInstruction_5_15 = HandleType(0, view_ReachableInstruction_0_FULL_VER.num_rows_, 0);
        auto intersect_16 = intersect_handles(tile, h_VirtualMethodInvocation_4_14.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_ReachableInstruction_5_15.iterators(view_ReachableInstruction_0_FULL_VER));
        for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
          auto invocation = it_17.value();
          auto positions = it_17.positions();
          auto ch_VirtualMethodInvocation_4_invocation = h_VirtualMethodInvocation_4_14.child_range(positions[0], invocation, tile, view_VirtualMethodInvocation_1_0_2_3_FULL_VER);
          auto ch_ReachableInstruction_5_invocation = h_ReachableInstruction_5_15.child_range(positions[1], invocation, tile, view_ReachableInstruction_0_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'simplename' from 2 sources
        // MIR: (column-join :var simplename :sources ((VirtualMethodInvocation :handle 6 :prefix (base invocation)) (HeapHelper :handle 7 :prefix (heap)) ))
        auto h_VirtualMethodInvocation_6_10 = ch_VirtualMethodInvocation_4_invocation;
        auto h_HeapHelper_7_11 = ch_HeapHelper_3_heap;
        auto intersect_12 = intersect_handles(tile, h_VirtualMethodInvocation_6_10.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_HeapHelper_7_11.iterators(view_HeapHelper_4_0_1_2_3_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          auto simplename = it_13.value();
          auto positions = it_13.positions();
          auto ch_VirtualMethodInvocation_6_simplename = h_VirtualMethodInvocation_6_10.child_range(positions[0], simplename, tile, view_VirtualMethodInvocation_1_0_2_3_FULL_VER);
          auto ch_HeapHelper_7_simplename = h_HeapHelper_7_11.child_range(positions[1], simplename, tile, view_HeapHelper_4_0_1_2_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'descriptor' from 2 sources
        // MIR: (column-join :var descriptor :sources ((VirtualMethodInvocation :handle 8 :prefix (base invocation simplename)) (HeapHelper :handle 9 :prefix (heap simplename)) ))
        auto h_VirtualMethodInvocation_8_6 = ch_VirtualMethodInvocation_6_simplename;
        auto h_HeapHelper_9_7 = ch_HeapHelper_7_simplename;
        auto intersect_8 = intersect_handles(tile, h_VirtualMethodInvocation_8_6.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_HeapHelper_9_7.iterators(view_HeapHelper_4_0_1_2_3_FULL_VER));
        for (auto it_9 = intersect_8.begin(); it_9.valid(); it_9.next()) {
          auto descriptor = it_9.value();
          auto positions = it_9.positions();
          auto ch_VirtualMethodInvocation_8_descriptor = h_VirtualMethodInvocation_8_6.child_range(positions[0], descriptor, tile, view_VirtualMethodInvocation_1_0_2_3_FULL_VER);
          auto ch_HeapHelper_9_descriptor = h_HeapHelper_9_7.child_range(positions[1], descriptor, tile, view_HeapHelper_4_0_1_2_3_FULL_VER);
        // Nested CartesianJoin: bind toMeth, thisP from 1 source(s)
        // MIR: (cartesian-join :vars (toMeth thisP) :sources ((HeapHelper :handle 10 :prefix (heap simplename descriptor)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();

        auto h_HeapHelper_10_4 = ch_HeapHelper_9_descriptor;  // reusing narrowed handle
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_2 output_ctx_2{output_data_2, output_prov_2, output_stride_2, old_size_2 + thread_offset};
        ...
        auto h_HeapHelper_3_21 = HandleType(0, view_HeapHelper_4_0_1_2_3_FULL_VER.num_rows_, 0);
        auto intersect_22 = intersect_handles(tile, h_VarPointsTo_2_20.iterators(view_VarPointsTo_1_0_DELTA_VER), h_HeapHelper_3_21.iterators(view_HeapHelper_4_0_1_2_3_FULL_VER));
        for (auto it_23 = intersect_22.begin(); it_23.valid(); it_23.next()) {
          ...
          auto ch_HeapHelper_3_heap = h_HeapHelper_3_21.child_range(positions[1], heap, tile, view_HeapHelper_4_0_1_2_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'invocation' from 2 sources
        // MIR: (column-join :var invocation :sources ((VirtualMethodInvocation :handle 4 :prefix (base)) (ReachableInstruction :handle 5 :prefix ()) ))
        ...
        auto h_HeapHelper_7_13 = ch_HeapHelper_3_heap;
        auto intersect_14 = intersect_handles(tile, h_VirtualMethodInvocation_6_12.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_HeapHelper_7_13.iterators(view_HeapHelper_4_0_1_2_3_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          ...
          auto ch_HeapHelper_7_simplename = h_HeapHelper_7_13.child_range(positions[1], simplename, tile, view_HeapHelper_4_0_1_2_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'descriptor' from 2 sources
        // MIR: (column-join :var descriptor :sources ((VirtualMethodInvocation :handle 8 :prefix (base invocation simplename)) (HeapHelper :handle 9 :prefix (heap simplename)) ))
        auto h_VirtualMethodInvocation_8_8 = ch_VirtualMethodInvocation_6_simplename;
        auto h_HeapHelper_9_9 = ch_HeapHelper_7_simplename;
        auto intersect_10 = intersect_handles(tile, h_VirtualMethodInvocation_8_8.iterators(view_VirtualMethodInvocation_1_0_2_3_FULL_VER), h_HeapHelper_9_9.iterators(view_HeapHelper_4_0_1_2_3_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          ...
          auto ch_HeapHelper_9_descriptor = h_HeapHelper_9_9.child_range(positions[1], descriptor, tile, view_HeapHelper_4_0_1_2_3_FULL_VER);
        // Nested CartesianJoin: bind toMeth, thisP from 1 source(s)
        // MIR: (cartesian-join :vars (toMeth thisP) :sources ((HeapHelper :handle 10 :prefix (heap simplename descriptor)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();
        ...
        for (uint32_t flat_idx_6 = lane_1; flat_idx_6 < total_5; flat_idx_6 += group_size_2) {
          ...
          auto toMeth = view_HeapHelper_4_0_1_2_3_FULL_VER.get_value(3, h_HeapHelper_10_4.begin() + idx0_7);
          auto thisP = view_HeapHelper_4_0_1_2_3_FULL_VER.get_value(4, h_HeapHelper_10_4.begin() + idx0_7);
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_bg_histogram(
    ...
    for (uint32_t bg_hist_key = warp_id; bg_hist_key < num_unique_root_keys; bg_hist_key += num_warps) {
      ...
      auto h_VirtualMethodInvocation_1_root = HandleType(0, view_VirtualMethodInvocation_1_0_2_3_FULL_VER.num_rows_, 0).prefix(bg_hist_root_val, tile, view_VirtualMethodInvocation_1_0_2_3_FULL_VER);
      if (!h_VirtualMethodInvocation_1_root.valid()) { bg_work_per_key[bg_hist_key] = 0; continue; }
      uint64_t bg_deg = 1;
      bg_deg *= h_VarPointsTo_0_root.degree();
      bg_deg *= h_VirtualMethodInvocation_1_root.degree();
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_bg_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        for (uint32_t bg_key_idx_1 = bg_key_lo; bg_key_idx_1 < num_unique_root_keys && bg_remaining_begin < bg_remaining_end; bg_key_idx_1++) {
          ...
          auto h_VirtualMethodInvocation_1_root = HandleType(0, view_VirtualMethodInvocation_1_0_2_3_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_VirtualMethodInvocation_1_0_2_3_FULL_VER);
          if (!h_VirtualMethodInvocation_1_root.valid()) { bg_remaining_begin = bg_key_work_end; continue; }
...
JitRunner_VirtualDispatch_MultiHead_D2::LaunchParams JitRunner_VirtualDispatch_MultiHead_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  // Source 1: VirtualMethodInvocation version FULL_VER
  {
    ...
    auto& idx_1 = rel_1.ensure_index(SRDatalog::IndexSpec{{1, 0, 2, 3}}, false);
    p.views_vec.push_back(idx_1.view());
  }

  // Source 3: HeapHelper version FULL_VER
  {
    auto& rel_3 = get_relation_by_schema<HeapHelper, FULL_VER>(db);
    auto& idx_3 = rel_3.ensure_index(SRDatalog::IndexSpec{{4, 0, 1, 2, 3}}, false);
    p.views_vec.push_back(idx_3.view());
  }

  // Source 5: ReachableInstruction version FULL_VER
  {
    auto& rel_5 = get_relation_by_schema<ReachableInstruction, FULL_VER>(db);
...
void JitRunner_VirtualDispatch_MultiHead_D2::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_VirtualDispatch_MultiHead_D2::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_VirtualDispatch_MultiHead_D2::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_VirtualDispatch_MultiHead_D2::read_total(LaunchParams& p) {
...
void JitRunner_VirtualDispatch_MultiHead_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_VirtualDispatch_MultiHead_D2::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_VirtualDispatch_MultiHead_D2::read_fused_result(LaunchParams& p) {
...
void JitRunner_VirtualDispatch_MultiHead_D2::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("VirtualDispatch_MultiHead_D2");
  ...
  auto& bg_dest_0 = get_relation_by_schema<VarPointsTo, NEW_VER>(db);
  uint32_t bg_old_size_0 = static_cast<uint32_t>(bg_dest_0.size());
  bg_dest_0.resize_interned_columns(bg_old_size_0 + total_count);
  auto& bg_dest_1 = get_relation_by_schema<CallGraphEdge, NEW_VER>(db);
  uint32_t bg_old_size_1 = static_cast<uint32_t>(bg_dest_1.size());
  bg_dest_1.resize_interned_columns(bg_old_size_1 + total_count);
  auto& bg_dest_2 = get_relation_by_schema<Reachable, NEW_VER>(db);
  uint32_t bg_old_size_2 = static_cast<uint32_t>(bg_dest_2.size());
  bg_dest_2.resize_interned_columns(bg_old_size_2 + total_count);

  // BG Step 5: Block-group materialize kernel
  kernel_bg_materialize<<<p.bg_num_blocks, kBlockSize>>>(p.d_views.data(), p.root_unique_values_ptr, p.head_root_unique_values_ptr, p.num_unique_root_keys, p.num_full_unique_root_keys, p.num_root_keys, bg_cumulative_work.data(), p.bg_total_work,p.thread_counts_ptr, bg_dest_0.template interned_column<0>(), static_cast<semiring_value_t<SR>*>(nullptr), bg_dest_0.interned_stride(), bg_old_size_0, bg_dest_1.template interned_column<0>(), static_cast<semiring_value_t<SR>*>(nullptr), bg_dest_1.interned_stride(), bg_old_size_1, bg_dest_2.template interned_column<0>(), static_cast<semiring_value_t<SR>*>(nullptr), bg_dest_2.interned_stride(), bg_old_size_2);
  cudaDeviceSynchronize();
  nvtxRangePop();
}

// Tail-mode fused execution: single kernel, no count/scan phase
void JitRunner_VirtualDispatch_MultiHead_D2::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
