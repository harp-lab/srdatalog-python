...
struct JitRunner_Join3a_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto intersect_14 = intersect_handles(tile, h_OutP_2_12.iterators(view_OutP_0_1_FULL_VER), h_UInput_3_13.iterators(view_UInput_0_1_2_FULL_VER));
        ...
        auto intersect_10 = intersect_handles(tile, h_OutQ_4_8.iterators(view_OutQ_2_1_0_DELTA_VER), h_UInput_5_9.iterators(view_UInput_0_1_2_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto r = it_11.value();
          auto positions = it_11.positions();
          auto ch_OutQ_4_r = h_OutQ_4_8.child_range(positions[0], r, tile, view_OutQ_2_1_0_DELTA_VER);
          auto ch_UInput_5_r = h_UInput_5_9.child_range(positions[1], r, tile, view_UInput_0_1_2_FULL_VER);
...
JitRunner_Join3a_D2::LaunchParams JitRunner_Join3a_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_Join3a_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
