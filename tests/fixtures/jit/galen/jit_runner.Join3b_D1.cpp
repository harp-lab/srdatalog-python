...
struct JitRunner_Join3b_D1 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto intersect_12 = intersect_handles(tile, h_OutP_2_10.iterators(view_OutP_0_1_DELTA_VER), h_CInput_3_11.iterators(view_CInput_1_0_2_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          ...
          auto ch_CInput_3_w = h_CInput_3_11.child_range(positions[1], w, tile, view_CInput_1_0_2_FULL_VER);
        ...
        auto intersect_8 = intersect_handles(tile, h_CInput_4_6.iterators(view_CInput_1_0_2_FULL_VER), h_OutP_5_7.iterators(view_OutP_0_1_FULL_VER));
        for (auto it_9 = intersect_8.begin(); it_9.valid(); it_9.next()) {
          auto y = it_9.value();
          auto positions = it_9.positions();
          auto ch_CInput_4_y = h_CInput_4_6.child_range(positions[0], y, tile, view_CInput_1_0_2_FULL_VER);
...
JitRunner_Join3b_D1::LaunchParams JitRunner_Join3b_D1::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_Join3b_D1::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
