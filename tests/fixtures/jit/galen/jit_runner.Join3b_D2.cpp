...
struct JitRunner_Join3b_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto intersect_12 = intersect_handles(tile, h_OutP_2_10.iterators(view_OutP_0_1_DELTA_VER), h_CInput_3_11.iterators(view_CInput_0_1_2_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          ...
          auto ch_CInput_3_y = h_CInput_3_11.child_range(positions[1], y, tile, view_CInput_0_1_2_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'w' from 2 sources
        // MIR: (column-join :var w :sources ((CInput :handle 4 :prefix (y)) (OutP :handle 5 :prefix (x)) ))
        auto h_CInput_4_6 = ch_CInput_3_y;
        auto h_OutP_5_7 = h_OutP_1_root;
        auto intersect_8 = intersect_handles(tile, h_CInput_4_6.iterators(view_CInput_0_1_2_FULL_VER), h_OutP_5_7.iterators(view_OutP_0_1_FULL_VER));
        for (auto it_9 = intersect_8.begin(); it_9.valid(); it_9.next()) {
          auto w = it_9.value();
          auto positions = it_9.positions();
          auto ch_CInput_4_w = h_CInput_4_6.child_range(positions[0], w, tile, view_CInput_0_1_2_FULL_VER);
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        auto intersect_14 = intersect_handles(tile, h_OutP_2_12.iterators(view_OutP_0_1_DELTA_VER), h_CInput_3_13.iterators(view_CInput_0_1_2_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          ...
          auto ch_CInput_3_y = h_CInput_3_13.child_range(positions[1], y, tile, view_CInput_0_1_2_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'w' from 2 sources
        // MIR: (column-join :var w :sources ((CInput :handle 4 :prefix (y)) (OutP :handle 5 :prefix (x)) ))
        auto h_CInput_4_8 = ch_CInput_3_y;
        auto h_OutP_5_9 = h_OutP_1_root;
        auto intersect_10 = intersect_handles(tile, h_CInput_4_8.iterators(view_CInput_0_1_2_FULL_VER), h_OutP_5_9.iterators(view_OutP_0_1_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto w = it_11.value();
          auto positions = it_11.positions();
          auto ch_CInput_4_w = h_CInput_4_8.child_range(positions[0], w, tile, view_CInput_0_1_2_FULL_VER);
...
JitRunner_Join3b_D2::LaunchParams JitRunner_Join3b_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_Join3b_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
