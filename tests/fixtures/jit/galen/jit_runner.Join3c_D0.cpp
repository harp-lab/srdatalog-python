...
struct JitRunner_Join3c_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto intersect_16 = intersect_handles(tile, h_OutQ_2_14.iterators(view_OutQ_2_1_0_DELTA_VER),
                                            h_RInput_3_15.iterators(view_RInput_0_1_2_FULL_VER));
      for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
        auto y = it_17.value();
        auto positions = it_17.positions();
        auto ch_OutQ_2_y =
            h_OutQ_2_14.child_range(positions[0], y, tile, view_OutQ_2_1_0_DELTA_VER);
        auto ch_RInput_3_y =
            h_RInput_3_15.child_range(positions[1], y, tile, view_RInput_0_1_2_FULL_VER);
        ...
        auto intersect_12 =
            intersect_handles(tile, h_RInput_4_10.iterators(view_RInput_0_1_2_FULL_VER),
                              h_OutQ_5_11.iterators(view_OutQ_0_1_2_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          auto u = it_13.value();
          auto positions = it_13.positions();
          auto ch_RInput_4_u =
              h_RInput_4_10.child_range(positions[0], u, tile, view_RInput_0_1_2_FULL_VER);
          auto ch_OutQ_5_u =
              h_OutQ_5_11.child_range(positions[1], u, tile, view_OutQ_0_1_2_FULL_VER);
...
JitRunner_Join3c_D0::LaunchParams JitRunner_Join3c_D0::setup(DB& db, uint32_t iteration,
                                                             GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_Join3c_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                             GPU_STREAM_T stream) {
