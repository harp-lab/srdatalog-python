  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          ...
          hint_hi_4 = (hint_hi_4 <= view_Edge_0_1_FULL_VER.num_rows_) ? hint_hi_4 : view_Edge_0_1_FULL_VER.num_rows_;
          hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_Edge_0_1_FULL_VER.num_rows_;
          auto h_Edge_0_root = HandleType(hint_lo_3, hint_hi_4, 0).prefix(root_val_2, tile, view_Edge_0_1_FULL_VER);
          if (!h_Edge_0_root.valid()) continue;
          auto h_Edge_1_root = HandleType(0, view_Edge_1_0_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_Edge_1_0_FULL_VER);
        ...
        auto intersect_7 = intersect_handles(tile, h_Edge_2_5.iterators(view_Edge_0_1_FULL_VER), h_Edge_3_6.iterators(view_Edge_0_1_FULL_VER));
        ...
        // MIR: (column-join :var z :sources ((Edge :handle 4 :prefix (y)) (Edge :handle 5 :prefix (x)) ))
        auto h_Edge_4_1 = ch_Edge_3_y;
        auto h_Edge_5_2 = h_Edge_1_root;
        auto intersect_3 = intersect_handles(tile, h_Edge_4_1.iterators(view_Edge_0_1_FULL_VER), h_Edge_5_2.iterators(view_Edge_1_0_FULL_VER));
