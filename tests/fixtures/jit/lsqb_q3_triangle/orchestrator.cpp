  ...
  static void step_0(DB& db, std::size_t max_iterations) {
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, NEW_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, NEW_VER>>(db, 0);

    using Knows_canonical_spec_t = SRDatalog::mir::IndexSpecT<Knows, std::integer_sequence<int, 0, 1>, FULL_VER>;
    using IsLocatedIn_canonical_spec_t = SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>;
    using IsPartOf_canonical_spec_t = SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>;
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedInInput, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOfInput, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    if (_tail_mode) {
    ...
    // === ParallelGroup (stream-parallel, 3 rules, shared dests) ===
    {
      ...
      {  // Resize IsLocatedIn
        ...
        if (sum_IsLocatedIn > 0) dest_IsLocatedIn.resize_interned_columns(base_offset_IsLocatedIn + sum_IsLocatedIn);
      ...
      {  // Resize IsPartOf
        ...
        if (sum_IsPartOf > 0) dest_IsPartOf.resize_interned_columns(base_offset_IsPartOf + sum_IsPartOf);
      ...
      if (total_1 > 0) JitRunner_LocLoad::launch_materialize(db, p_1, total_1, _stream_pool.get(1));
      if (total_2 > 0) JitRunner_PartOfLoad::launch_materialize(db, p_2, total_2, _stream_pool.get(2));
    ...
    nvtxRangePop();  // merge
    SRDatalog::GPU::mir_helpers::rebuild_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, NEW_VER>>(db);
    SRDatalog::GPU::mir_helpers::check_size_fn<IsLocatedIn, NEW_VER, IsLocatedIn_canonical_spec_t>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::compute_delta_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, NEW_VER>, SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>, SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db);
    nvtxRangePop();  // merge
    SRDatalog::GPU::mir_helpers::clear_relation_fn<IsLocatedIn, NEW_VER>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::merge_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>>(db);
    nvtxRangePop();  // merge
    SRDatalog::GPU::mir_helpers::rebuild_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, NEW_VER>>(db);
    SRDatalog::GPU::mir_helpers::check_size_fn<IsPartOf, NEW_VER, IsPartOf_canonical_spec_t>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::compute_delta_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, NEW_VER>, SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>, SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db);
    nvtxRangePop();  // merge
    SRDatalog::GPU::mir_helpers::clear_relation_fn<IsPartOf, NEW_VER>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::merge_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db);
    nvtxRangePop();  // merge
  }
  template <typename DB>
  ...
  static void step_2(DB& db, std::size_t max_iterations) {
    mir_helpers::reconstruct_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>>(db);
    GPU_DEVICE_SYNCHRONIZE();
  }
  template <typename DB>
  static void step_3(DB& db, std::size_t max_iterations) {
    mir_helpers::reconstruct_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db);
    GPU_DEVICE_SYNCHRONIZE();
  }
  template <typename DB>
  static void step_4(DB& db, std::size_t max_iterations) {
    // Build output indexes
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, NEW_VER>>(db, 0);

    using Triangle_canonical_spec_t = SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, FULL_VER>;
    bool _tail_mode = false;

    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Knows, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Knows, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsLocatedIn, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<IsPartOf, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    if (_tail_mode) JitRunner_LabeledTriangle::execute_fused(db, 0); else JitRunner_LabeledTriangle::execute(db, 0);
    SRDatalog::GPU::mir_helpers::rebuild_index_fn<SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, NEW_VER>>(db);
    SRDatalog::GPU::mir_helpers::check_size_fn<Triangle, NEW_VER, Triangle_canonical_spec_t>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::compute_delta_index_fn<SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, NEW_VER>, SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, FULL_VER>, SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, DELTA_VER>>(db);
    nvtxRangePop();  // merge
    SRDatalog::GPU::mir_helpers::clear_relation_fn<Triangle, NEW_VER>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::merge_index_fn<SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, FULL_VER>>(db);
    nvtxRangePop();  // merge
  }
  template <typename DB>
  static void step_5(DB& db, std::size_t max_iterations) {
    mir_helpers::reconstruct_fn<SRDatalog::mir::IndexSpecT<Triangle, std::integer_sequence<int, 0, 1, 2>, FULL_VER>>(db);
    GPU_DEVICE_SYNCHRONIZE();
  }
