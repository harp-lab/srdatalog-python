...
JitRunner_ancestor_path_base::LaunchParams JitRunner_ancestor_path_base::setup(
...
uint32_t JitRunner_ancestor_path_base::scan_and_resize(DB& db, LaunchParams& p,
                                                       GPU_STREAM_T stream) {
...
void JitRunner_ancestor_path_base::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                      GPU_STREAM_T stream) {
