...
JitRunner_kps_transitive_D0::LaunchParams JitRunner_kps_transitive_D0::setup(DB& db,
                                                                             uint32_t iteration,
                                                                             GPU_STREAM_T stream) {
  LaunchParams p;
...
uint32_t JitRunner_kps_transitive_D0::scan_and_resize(DB& db, LaunchParams& p,
                                                      GPU_STREAM_T stream) {
...
void JitRunner_kps_transitive_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                     GPU_STREAM_T stream) {
