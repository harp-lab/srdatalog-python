...
JitRunner_path_assigned_at_base_rule::LaunchParams JitRunner_path_assigned_at_base_rule::setup(
...
uint32_t JitRunner_path_assigned_at_base_rule::scan_and_resize(DB& db, LaunchParams& p,
                                                               GPU_STREAM_T stream) {
...
void JitRunner_path_assigned_at_base_rule::launch_materialize(DB& db, LaunchParams& p,
...
void JitRunner_path_assigned_at_base_rule::launch_fused(DB& db, LaunchParams& p,
                                                        GPU_STREAM_T stream) {
  if (p.num_unique_root_keys == 0)
    return;
