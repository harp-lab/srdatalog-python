...
JitRunner_path_moved_at_base_rule::LaunchParams JitRunner_path_moved_at_base_rule::setup(
...
uint32_t JitRunner_path_moved_at_base_rule::scan_and_resize(DB& db, LaunchParams& p,
                                                            GPU_STREAM_T stream) {
...
void JitRunner_path_moved_at_base_rule::launch_materialize(DB& db, LaunchParams& p,
