...
JitRunner_subset_error_rule::LaunchParams JitRunner_subset_error_rule::setup(DB& db,
                                                                             uint32_t iteration,
                                                                             GPU_STREAM_T stream) {
  LaunchParams p;
...
uint32_t JitRunner_subset_error_rule::scan_and_resize(DB& db, LaunchParams& p,
                                                      GPU_STREAM_T stream) {
...
void JitRunner_subset_error_rule::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                     GPU_STREAM_T stream) {
