  ...
  static void step_0(DB& db, std::size_t max_iterations) {
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, NEW_VER>>(db, 0);

    using PointsTo_canonical_spec_t = SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>;
    ...
    if (_tail_mode) JitRunner_Base::execute_fused(db, 0); else JitRunner_Base::execute(db, 0);
    SRDatalog::GPU::mir_helpers::rebuild_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, NEW_VER>>(db);
    SRDatalog::GPU::mir_helpers::check_size_fn<PointsTo, NEW_VER, PointsTo_canonical_spec_t>(db);
    nvtxRangePushA("merge");
    SRDatalog::GPU::mir_helpers::compute_delta_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, NEW_VER>, SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>, SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db);
    nvtxRangePop();  // merge
    ...
    nvtxRangePop();  // merge
    SRDatalog::GPU::mir_helpers::rebuild_index_from_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>, SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 1, 0>, DELTA_VER>>(db);
    nvtxRangePushA("merge");
  ...
  static void step_1(DB& db, std::size_t max_iterations) {
    mir_helpers::reconstruct_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db);
  ...
  static void step_2(DB& db, std::size_t max_iterations) {
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Load, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Load, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Load, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Store, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Store, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    ...
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Store, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<Store, std::integer_sequence<int, 1, 0>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, DELTA_VER>>(db, 0);
    mir_helpers::create_index_fn<SRDatalog::mir::IndexSpecT<PointsTo, std::integer_sequence<int, 0, 1>, FULL_VER>>(db, 0);
    ...
    for (std::size_t iter = 0; iter < max_iterations; ++iter) {
      if (iter > 0) {
        ...
        if (std::getenv("SRDATALOG_PRINT_DELTA_DETAIL")) {
          std::cerr << "[iter " << iter << "]";
          {
            ...
            try { auto& _di = _dr.get_index(_sp); std::cerr << " PointsTo=" << _di.root().degree(); } catch (...) { std::cerr << " PointsTo=?"; }
          }
          std::cerr << std::endl;
      ...
      // === ParallelGroup (stream-parallel, 5 rules, shared dests) ===
      {
        ...
        uint32_t shared_buf_PointsTo_size = p_0.num_threads + p_1.num_threads + p_2.num_threads + p_3.num_threads + p_4.num_threads + 1;
        ...
        thrust::exclusive_scan(rmm::exec_policy(_stream_pool.get(0)), shared_buf_PointsTo.data(), shared_buf_PointsTo.data() + shared_buf_PointsTo_size, shared_buf_PointsTo.data(), 0, thrust::plus<uint32_t>());

        // Phase 3b: Single sync + readback all totals
        GPU_DEVICE_SYNCHRONIZE();
        // Read boundary values for PointsTo (5 rules)
        uint32_t bnd_PointsTo[6];
        GPU_MEMCPY_ASYNC(&bnd_PointsTo[0], shared_buf_PointsTo.data() + off_PointsTo_0, sizeof(uint32_t), GPU_DEVICE_TO_HOST, 0);
        GPU_MEMCPY_ASYNC(&bnd_PointsTo[1], shared_buf_PointsTo.data() + off_PointsTo_1, sizeof(uint32_t), GPU_DEVICE_TO_HOST, 0);
        GPU_MEMCPY_ASYNC(&bnd_PointsTo[2], shared_buf_PointsTo.data() + off_PointsTo_2, sizeof(uint32_t), GPU_DEVICE_TO_HOST, 0);
        GPU_MEMCPY_ASYNC(&bnd_PointsTo[3], shared_buf_PointsTo.data() + off_PointsTo_3, sizeof(uint32_t), GPU_DEVICE_TO_HOST, 0);
        GPU_MEMCPY_ASYNC(&bnd_PointsTo[4], shared_buf_PointsTo.data() + off_PointsTo_4, sizeof(uint32_t), GPU_DEVICE_TO_HOST, 0);
        GPU_MEMCPY_ASYNC(&bnd_PointsTo[5], shared_buf_PointsTo.data() + shared_buf_PointsTo_size - 1, sizeof(uint32_t), GPU_DEVICE_TO_HOST, 0);
        ...
        {  // Resize PointsTo
          ...
          if (sum_PointsTo > 0) dest_PointsTo.resize_interned_columns(base_offset_PointsTo + sum_PointsTo);
        ...
        if (total_0 > 0) JitRunner_Assign_D0::launch_materialize(db, p_0, total_0, _stream_pool.get(0));
        if (total_1 > 0) JitRunner_Load_D0::launch_materialize(db, p_1, total_1, _stream_pool.get(1));
        if (total_2 > 0) JitRunner_Load_D2::launch_materialize(db, p_2, total_2, _stream_pool.get(2));
        if (total_3 > 0) JitRunner_Store_D0::launch_materialize(db, p_3, total_3, _stream_pool.get(3));
        if (total_4 > 0) JitRunner_Store_D2::launch_materialize(db, p_4, total_4, _stream_pool.get(4));
