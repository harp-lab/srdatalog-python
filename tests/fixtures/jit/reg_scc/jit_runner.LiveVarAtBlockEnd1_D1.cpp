...
struct JitRunner_LiveVarAtBlockEnd1_D1 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      // MIR: (cartesian-join :vars (mvar _gen10 _gen11 prevBlock prevBlockEnd) :sources
      // ((RegDefUseLiveVarUsed :handle 2 :prefix (blk)) (BlockNext :handle 3 :prefix (blk)) ))
      ...
      if (!h_RegDefUseLiveVarUsed_2_6.valid() || !h_BlockNext_3_8.valid())
        continue;
      ...
      auto h_RegDefUseFlowDef_neg_pre_1 =
          HandleType(0, view_RegDefUseFlowDef_2_1_0_3_FULL_VER.num_rows_, 0)
              .prefix(blk, tile, view_RegDefUseFlowDef_2_1_0_3_FULL_VER);
      ...
      for (uint32_t flat_idx_10 = lane_3; flat_idx_10 < total_9; flat_idx_10 += group_size_4) {
        ...
        auto mvar = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
            1, h_RegDefUseLiveVarUsed_2_6.begin() + idx0_11);
        auto prevBlock =
            view_BlockNext_2_0_1_FULL_VER.get_value(1, h_BlockNext_3_8.begin() + idx1_12);
        auto prevBlockEnd =
            view_BlockNext_2_0_1_FULL_VER.get_value(2, h_BlockNext_3_8.begin() + idx1_12);
        ...
        auto h_RegDefUseFlowDef_neg_4_2 =
            h_RegDefUseFlowDef_neg_pre_1.prefix_seq(mvar, view_RegDefUseFlowDef_2_1_0_3_FULL_VER)
                .prefix_seq(prevBlockEnd, view_RegDefUseFlowDef_2_1_0_3_FULL_VER);
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      for (uint32_t flat_idx_10 = lane_3; flat_idx_10 < total_9; flat_idx_10 += group_size_4) {
        ...
        auto mvar = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
            1, h_RegDefUseLiveVarUsed_2_6.begin() + idx0_11);
        auto _gen10 = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
            2, h_RegDefUseLiveVarUsed_2_6.begin() + idx0_11);
        auto _gen11 = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
            3, h_RegDefUseLiveVarUsed_2_6.begin() + idx0_11);
        auto prevBlock =
            view_BlockNext_2_0_1_FULL_VER.get_value(1, h_BlockNext_3_8.begin() + idx1_12);
        auto prevBlockEnd =
            view_BlockNext_2_0_1_FULL_VER.get_value(2, h_BlockNext_3_8.begin() + idx1_12);
...
JitRunner_LiveVarAtBlockEnd1_D1::LaunchParams JitRunner_LiveVarAtBlockEnd1_D1::setup(
...
uint32_t JitRunner_LiveVarAtBlockEnd1_D1::scan_and_resize(DB& db, LaunchParams& p,
                                                          GPU_STREAM_T stream) {
...
void JitRunner_LiveVarAtBlockEnd1_D1::launch_materialize(DB& db, LaunchParams& p,
