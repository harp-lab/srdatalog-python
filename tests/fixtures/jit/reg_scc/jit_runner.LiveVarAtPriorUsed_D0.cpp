...
JitRunner_LiveVarAtPriorUsed_D0::LaunchParams JitRunner_LiveVarAtPriorUsed_D0::setup(
...
uint32_t JitRunner_LiveVarAtPriorUsed_D0::scan_and_resize(DB& db, LaunchParams& p,
                                                          GPU_STREAM_T stream) {
...
void JitRunner_LiveVarAtPriorUsed_D0::launch_materialize(DB& db, LaunchParams& p,
