// =============================================================
// JIT-Generated Complete Runner: LiveVarUsed2_D2
// Fully concrete - NO C++ templates/metaprogramming
// =============================================================

struct JitRunner_LiveVarUsed2_D2 {
  ...
  using DestSchema = RegDefUseLiveVarUsed;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      uint32_t hint_hi_4 = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.num_rows_ -
                           (num_unique_root_keys - y_idx_1 - 1);
      hint_hi_4 = (hint_hi_4 <= view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.num_rows_)
                      ? hint_hi_4
                      : view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.num_rows_;
      hint_hi_4 = (hint_hi_4 > hint_lo_3)
                      ? hint_hi_4
                      : view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.num_rows_;
      auto h_RegDefUseReturnValUsed_0_root =
          HandleType(hint_lo_3, hint_hi_4, 0)
              .prefix(root_val_2, tile, view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER);
      if (!h_RegDefUseReturnValUsed_0_root.valid())
        continue;
      auto h_RegDefUseReturnBlockEnd_1_root =
          HandleType(0, view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER);
      if (!h_RegDefUseReturnBlockEnd_1_root.valid())
        continue;
      auto callee = root_val_2;
      // Nested CartesianJoin: bind _gen8, reg, eaUsed, index, _gen6, retBlock, retBlockEnd from 2
      // source(s) MIR: (cartesian-join :vars (_gen8 reg eaUsed index _gen6 retBlock retBlockEnd)
      // :sources ((RegDefUseReturnValUsed :handle 2 :prefix (callee)) (RegDefUseReturnBlockEnd
      // :handle 3 :prefix (callee)) ))
      uint32_t lane_2 = tile.thread_rank();
      uint32_t group_size_3 = tile.size();

      auto h_RegDefUseReturnValUsed_2_5 =
          h_RegDefUseReturnValUsed_0_root;  // reusing narrowed handle
      auto h_RegDefUseReturnBlockEnd_3_7 =
          h_RegDefUseReturnBlockEnd_1_root;  // reusing narrowed handle

      if (!h_RegDefUseReturnValUsed_2_5.valid() || !h_RegDefUseReturnBlockEnd_3_7.valid())
        continue;
      ...
      for (uint32_t flat_idx_9 = lane_2; flat_idx_9 < total_8; flat_idx_9 += group_size_3) {
        ...
        auto reg = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            2, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto eaUsed = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            3, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto index = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            4, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto retBlock = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(
            2, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
        auto retBlockEnd = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(
            3, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);

        // Negation: NOT EXISTS in RegDefUseBlockLastDef
        // MIR: (negation :rel RegDefUseBlockLastDef :prefix (reg retBlockEnd) :handle 4)
        auto h_RegDefUseBlockLastDef_neg_4_1 =
            HandleType(0, view_RegDefUseBlockLastDef_2_0_1_FULL_VER.num_rows_, 0)
                .prefix_seq(reg, view_RegDefUseBlockLastDef_2_0_1_FULL_VER)
                .prefix_seq(retBlockEnd, view_RegDefUseBlockLastDef_2_0_1_FULL_VER);
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      for (uint32_t flat_idx_9 = lane_2; flat_idx_9 < total_8; flat_idx_9 += group_size_3) {
        ...
        auto _gen8 = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            1, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto reg = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            2, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto eaUsed = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            3, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto index = view_RegDefUseReturnValUsed_1_0_2_3_4_DELTA_VER.get_value(
            4, h_RegDefUseReturnValUsed_2_5.begin() + idx0_10);
        auto _gen6 = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(
            1, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
        auto retBlock = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(
            2, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
        auto retBlockEnd = view_RegDefUseReturnBlockEnd_0_1_2_3_FULL_VER.get_value(
            3, h_RegDefUseReturnBlockEnd_3_7.begin() + idx1_11);
        ...
        if (!h_RegDefUseBlockLastDef_neg_4_1.valid()) {
          // Emit: RegDefUseLiveVarUsed(retBlock, reg, eaUsed, index)
          output_ctx_0.emit_direct(retBlock, reg, eaUsed, index);
        }
      }
    }
  }
...
JitRunner_LiveVarUsed2_D2::LaunchParams JitRunner_LiveVarUsed2_D2::setup(DB& db, uint32_t iteration,
                                                                         GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<RegDefUseReturnValUsed, FULL_VER>(db)
                                   : get_relation_by_schema<RegDefUseReturnValUsed, DELTA_VER>(db);
    auto& idx_0 = rel_0.ensure_index(SRDatalog::IndexSpec{{1, 0, 2, 3, 4}}, false);
  ...
  // Source 4: RegDefUseBlockLastDef version FULL_VER
  {
    auto& rel_4 = get_relation_by_schema<RegDefUseBlockLastDef, FULL_VER>(db);
    auto& idx_4 = rel_4.ensure_index(SRDatalog::IndexSpec{{2, 0, 1}}, true);
    p.views_vec.push_back(idx_4.view());
  }

  // First source for root keys
  auto& first_rel = (iteration == 0)
                        ? get_relation_by_schema<RegDefUseReturnValUsed, FULL_VER>(db)
                        : get_relation_by_schema<RegDefUseReturnValUsed, DELTA_VER>(db);
  auto& first_idx = first_rel.get_index(SRDatalog::IndexSpec{{1, 0, 2, 3, 4}});
...
void JitRunner_LiveVarUsed2_D2::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0)
    return;
...
uint32_t JitRunner_LiveVarUsed2_D2::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
  ...
  auto& dest_rel_0 = get_relation_by_schema<RegDefUseLiveVarUsed, NEW_VER>(db);
...
void JitRunner_LiveVarUsed2_D2::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0)
    return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr,
                         p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0,
...
uint32_t JitRunner_LiveVarUsed2_D2::read_total(LaunchParams& p) {
  if (p.num_threads == 0)
    return 0;
  uint32_t total_count = 0;
...
void JitRunner_LiveVarUsed2_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                   GPU_STREAM_T stream) {
...
void JitRunner_LiveVarUsed2_D2::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_unique_root_keys == 0)
    return;
...
void JitRunner_LiveVarUsed2_D2::read_fused_result(LaunchParams& p) {
...
void JitRunner_LiveVarUsed2_D2::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("LiveVarUsed2_D2");
...
void JitRunner_LiveVarUsed2_D2::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0)
    return;
