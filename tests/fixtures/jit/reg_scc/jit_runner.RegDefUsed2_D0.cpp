...
struct JitRunner_RegDefUsed2_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    auto view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER = views[2];
    ...
    // (RegDefUseLiveVarDef :handle 1) )) WARP MODE: 32 threads cooperatively handle one row
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      if (!h_RegDefUseLiveVarAtBlockEnd_0_root.valid())
        continue;
      auto h_RegDefUseLiveVarDef_1_root =
          HandleType(0, view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER);
      if (!h_RegDefUseLiveVarDef_1_root.valid())
        continue;
      auto blk = root_val_2;
      // Nested ColumnJoin (intersection): bind 'blockUsed' from 2 sources
      // MIR: (column-join :var blockUsed :sources ((RegDefUseLiveVarAtBlockEnd :handle 2 :prefix
      // (blk)) (RegDefUseLiveVarUsed :handle 3 :prefix ()) ))
      auto h_RegDefUseLiveVarAtBlockEnd_2_13 = h_RegDefUseLiveVarAtBlockEnd_0_root;
      auto h_RegDefUseLiveVarUsed_3_14 =
          HandleType(0, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER.num_rows_, 0);
      auto intersect_15 = intersect_handles(
          tile,
          h_RegDefUseLiveVarAtBlockEnd_2_13.iterators(
              view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER),
          h_RegDefUseLiveVarUsed_3_14.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER));
      for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
        auto blockUsed = it_16.value();
        auto positions = it_16.positions();
        auto ch_RegDefUseLiveVarAtBlockEnd_2_blockUsed =
            h_RegDefUseLiveVarAtBlockEnd_2_13.child_range(
                positions[0], blockUsed, tile, view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER);
        auto ch_RegDefUseLiveVarUsed_3_blockUsed = h_RegDefUseLiveVarUsed_3_14.child_range(
            positions[1], blockUsed, tile, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'mvar' from 3 sources
        // MIR: (column-join :var mvar :sources ((RegDefUseLiveVarAtBlockEnd :handle 4 :prefix (blk
        // blockUsed)) (RegDefUseLiveVarDef :handle 5 :prefix (blk)) (RegDefUseLiveVarUsed :handle 6
        // :prefix (blockUsed)) ))
        auto h_RegDefUseLiveVarAtBlockEnd_4_8 = ch_RegDefUseLiveVarAtBlockEnd_2_blockUsed;
        auto h_RegDefUseLiveVarDef_5_9 = h_RegDefUseLiveVarDef_1_root;
        auto h_RegDefUseLiveVarUsed_6_10 = ch_RegDefUseLiveVarUsed_3_blockUsed;
        auto intersect_11 = intersect_handles(
            tile,
            h_RegDefUseLiveVarAtBlockEnd_4_8.iterators(
                view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER),
            h_RegDefUseLiveVarDef_5_9.iterators(view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER),
            h_RegDefUseLiveVarUsed_6_10.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER));
        for (auto it_12 = intersect_11.begin(); it_12.valid(); it_12.next()) {
          auto mvar = it_12.value();
          auto positions = it_12.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_4_mvar = h_RegDefUseLiveVarAtBlockEnd_4_8.child_range(
              positions[0], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER);
          auto ch_RegDefUseLiveVarDef_5_mvar = h_RegDefUseLiveVarDef_5_9.child_range(
              positions[1], mvar, tile, view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER);
          auto ch_RegDefUseLiveVarUsed_6_mvar = h_RegDefUseLiveVarUsed_6_10.child_range(
              positions[2], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER);
          // Nested CartesianJoin: bind varIdentity, eaDef, eaUsed, index from 2 source(s)
          // MIR: (cartesian-join :vars (varIdentity eaDef eaUsed index) :sources
          // ((RegDefUseLiveVarDef :handle 7 :prefix (blk mvar)) (RegDefUseLiveVarUsed :handle 8
          // :prefix (blockUsed mvar)) ))
          uint32_t lane_1 = tile.thread_rank();
          uint32_t group_size_2 = tile.size();

          auto h_RegDefUseLiveVarDef_7_4 =
              ch_RegDefUseLiveVarDef_5_mvar;  // reusing narrowed handle
          auto h_RegDefUseLiveVarUsed_8_6 =
              ch_RegDefUseLiveVarUsed_6_mvar;  // reusing narrowed handle

          if (!h_RegDefUseLiveVarDef_7_4.valid() || !h_RegDefUseLiveVarUsed_8_6.valid())
            continue;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto h_RegDefUseLiveVarUsed_3_18 =
          HandleType(0, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER.num_rows_, 0);
      auto intersect_19 = intersect_handles(
          tile,
          h_RegDefUseLiveVarAtBlockEnd_2_17.iterators(
              view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER),
          h_RegDefUseLiveVarUsed_3_18.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER));
      for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
        auto blockUsed = it_20.value();
        auto positions = it_20.positions();
        auto ch_RegDefUseLiveVarAtBlockEnd_2_blockUsed =
            h_RegDefUseLiveVarAtBlockEnd_2_17.child_range(
                positions[0], blockUsed, tile, view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER);
        auto ch_RegDefUseLiveVarUsed_3_blockUsed = h_RegDefUseLiveVarUsed_3_18.child_range(
            positions[1], blockUsed, tile, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'mvar' from 3 sources
        // MIR: (column-join :var mvar :sources ((RegDefUseLiveVarAtBlockEnd :handle 4 :prefix (blk
        // blockUsed)) (RegDefUseLiveVarDef :handle 5 :prefix (blk)) (RegDefUseLiveVarUsed :handle 6
        ...
        auto intersect_15 = intersect_handles(
            tile,
            h_RegDefUseLiveVarAtBlockEnd_4_12.iterators(
                view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER),
            h_RegDefUseLiveVarDef_5_13.iterators(view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER),
            h_RegDefUseLiveVarUsed_6_14.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER));
        for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
          auto mvar = it_16.value();
          auto positions = it_16.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_4_mvar = h_RegDefUseLiveVarAtBlockEnd_4_12.child_range(
              positions[0], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER);
          auto ch_RegDefUseLiveVarDef_5_mvar = h_RegDefUseLiveVarDef_5_13.child_range(
              positions[1], mvar, tile, view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER);
          auto ch_RegDefUseLiveVarUsed_6_mvar = h_RegDefUseLiveVarUsed_6_14.child_range(
              positions[2], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER);
          // Nested CartesianJoin: bind varIdentity, eaDef, eaUsed, index from 2 source(s)
          // MIR: (cartesian-join :vars (varIdentity eaDef eaUsed index) :sources
          // ((RegDefUseLiveVarDef :handle 7 :prefix (blk mvar)) (RegDefUseLiveVarUsed :handle 8
          ...
          for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
            ...
            auto varIdentity = view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER.get_value(
                2, h_RegDefUseLiveVarDef_7_4.begin() + idx0_9);
            auto eaDef = view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER.get_value(
                3, h_RegDefUseLiveVarDef_7_4.begin() + idx0_9);
            auto eaUsed = view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER.get_value(
                2, h_RegDefUseLiveVarUsed_8_6.begin() + idx1_10);
            auto index = view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER.get_value(
...
JitRunner_RegDefUsed2_D0::LaunchParams JitRunner_RegDefUsed2_D0::setup(DB& db, uint32_t iteration,
                                                                       GPU_STREAM_T stream) {
  LaunchParams p;
  p.views_vec.reserve(NumSources);

  // Source 0: RegDefUseLiveVarAtBlockEnd version DELTA_VER
  {
    auto& rel_0 = (iteration == 0)
                      ? get_relation_by_schema<RegDefUseLiveVarAtBlockEnd, FULL_VER>(db)
                      : get_relation_by_schema<RegDefUseLiveVarAtBlockEnd, DELTA_VER>(db);
    auto& idx_0 = rel_0.ensure_index(SRDatalog::IndexSpec{{0, 1, 2}}, false);
    p.views_vec.push_back(idx_0.view());
  }

  // Source 1: RegDefUseLiveVarDef version FULL_VER
  {
    auto& rel_1 = get_relation_by_schema<RegDefUseLiveVarDef, FULL_VER>(db);
    auto& idx_1 = rel_1.ensure_index(SRDatalog::IndexSpec{{0, 2, 1, 3}}, false);
    p.views_vec.push_back(idx_1.view());
  }

  // Source 3: RegDefUseLiveVarUsed version FULL_VER
  {
...
void JitRunner_RegDefUsed2_D0::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0)
    return;
...
uint32_t JitRunner_RegDefUsed2_D0::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed2_D0::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0)
    return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr,
                         p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0,
...
uint32_t JitRunner_RegDefUsed2_D0::read_total(LaunchParams& p) {
  if (p.num_threads == 0)
    return 0;
  uint32_t total_count = 0;
...
void JitRunner_RegDefUsed2_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                  GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed2_D0::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_unique_root_keys == 0)
    return;
...
void JitRunner_RegDefUsed2_D0::read_fused_result(LaunchParams& p) {
...
void JitRunner_RegDefUsed2_D0::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("RegDefUsed2_D0");
...
void JitRunner_RegDefUsed2_D0::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0)
    return;
