  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
          ...
          auto ch_RegDefUseLiveVarUsed_3_blockUsed = h_RegDefUseLiveVarUsed_3_14.child_range(positions[1], blockUsed, tile, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER);
        ...
        auto intersect_11 = intersect_handles(tile, h_RegDefUseLiveVarAtBlockEnd_4_8.iterators(view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER), h_RegDefUseLiveVarDef_5_9.iterators(view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER), h_RegDefUseLiveVarUsed_6_10.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER));
        for (auto it_12 = intersect_11.begin(); it_12.valid(); it_12.next()) {
          auto mvar = it_12.value();
          auto positions = it_12.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_4_mvar = h_RegDefUseLiveVarAtBlockEnd_4_8.child_range(positions[0], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_0_1_2_DELTA_VER);
          auto ch_RegDefUseLiveVarDef_5_mvar = h_RegDefUseLiveVarDef_5_9.child_range(positions[1], mvar, tile, view_RegDefUseLiveVarDef_0_2_1_3_FULL_VER);
          auto ch_RegDefUseLiveVarUsed_6_mvar = h_RegDefUseLiveVarUsed_6_10.child_range(positions[2], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_FULL_VER);
...
JitRunner_RegDefUsed2_D0::LaunchParams JitRunner_RegDefUsed2_D0::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_RegDefUsed2_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
