...
struct JitRunner_RegDefUsed2_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    // MIR: (column-join :var blockUsed :sources ((RegDefUseLiveVarUsed :handle 0)
    // (RegDefUseLiveVarAtBlockEnd :handle 1) )) WARP MODE: 32 threads cooperatively handle one row
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      if (!h_RegDefUseLiveVarUsed_0_root.valid())
        continue;
      auto h_RegDefUseLiveVarAtBlockEnd_1_root =
          HandleType(0, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
      if (!h_RegDefUseLiveVarAtBlockEnd_1_root.valid())
        continue;
      auto blockUsed = root_val_2;
      // Nested ColumnJoin (intersection): bind 'mvar' from 3 sources
      // MIR: (column-join :var mvar :sources ((RegDefUseLiveVarUsed :handle 2 :prefix (blockUsed))
      // (RegDefUseLiveVarAtBlockEnd :handle 3 :prefix (blockUsed)) (RegDefUseLiveVarDef :handle 4
      // :prefix ()) ))
      ...
      auto h_RegDefUseLiveVarDef_4_14 =
          HandleType(0, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.num_rows_, 0);
      auto intersect_15 = intersect_handles(
          ...
          h_RegDefUseLiveVarAtBlockEnd_3_13.iterators(
              view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER),
          h_RegDefUseLiveVarDef_4_14.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
      for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
        ...
        auto ch_RegDefUseLiveVarAtBlockEnd_3_mvar = h_RegDefUseLiveVarAtBlockEnd_3_13.child_range(
            positions[1], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
        auto ch_RegDefUseLiveVarDef_4_mvar = h_RegDefUseLiveVarDef_4_14.child_range(
            positions[2], mvar, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'blk' from 2 sources
        // MIR: (column-join :var blk :sources ((RegDefUseLiveVarAtBlockEnd :handle 5 :prefix
        // (blockUsed mvar)) (RegDefUseLiveVarDef :handle 6 :prefix (mvar)) ))
        ...
        auto intersect_10 = intersect_handles(
            tile,
            h_RegDefUseLiveVarAtBlockEnd_5_8.iterators(
                view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER),
            h_RegDefUseLiveVarDef_6_9.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto blk = it_11.value();
          auto positions = it_11.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_5_blk = h_RegDefUseLiveVarAtBlockEnd_5_8.child_range(
              positions[0], blk, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
          auto ch_RegDefUseLiveVarDef_6_blk = h_RegDefUseLiveVarDef_6_9.child_range(
              positions[1], blk, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
          // Nested CartesianJoin: bind eaUsed, index, varIdentity, eaDef from 2 source(s)
          // MIR: (cartesian-join :vars (eaUsed index varIdentity eaDef) :sources
          // ((RegDefUseLiveVarUsed :handle 7 :prefix (blockUsed mvar)) (RegDefUseLiveVarDef :handle
          // 8 :prefix (mvar blk)) ))
          ...
          if (!h_RegDefUseLiveVarUsed_7_4.valid() || !h_RegDefUseLiveVarDef_8_6.valid())
            continue;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto h_RegDefUseLiveVarDef_4_18 =
          HandleType(0, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.num_rows_, 0);
      auto intersect_19 = intersect_handles(
          ...
          h_RegDefUseLiveVarAtBlockEnd_3_17.iterators(
              view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER),
          h_RegDefUseLiveVarDef_4_18.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
      for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
        ...
        auto ch_RegDefUseLiveVarUsed_2_mvar = h_RegDefUseLiveVarUsed_2_16.child_range(
            positions[0], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER);
        auto ch_RegDefUseLiveVarAtBlockEnd_3_mvar = h_RegDefUseLiveVarAtBlockEnd_3_17.child_range(
            positions[1], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
        auto ch_RegDefUseLiveVarDef_4_mvar = h_RegDefUseLiveVarDef_4_18.child_range(
            positions[2], mvar, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'blk' from 2 sources
        // MIR: (column-join :var blk :sources ((RegDefUseLiveVarAtBlockEnd :handle 5 :prefix
        // (blockUsed mvar)) (RegDefUseLiveVarDef :handle 6 :prefix (mvar)) ))
        ...
        auto intersect_14 = intersect_handles(
            tile,
            h_RegDefUseLiveVarAtBlockEnd_5_12.iterators(
                view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER),
            h_RegDefUseLiveVarDef_6_13.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          auto blk = it_15.value();
          auto positions = it_15.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_5_blk = h_RegDefUseLiveVarAtBlockEnd_5_12.child_range(
              positions[0], blk, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
          auto ch_RegDefUseLiveVarDef_6_blk = h_RegDefUseLiveVarDef_6_13.child_range(
              positions[1], blk, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
          // Nested CartesianJoin: bind eaUsed, index, varIdentity, eaDef from 2 source(s)
          // MIR: (cartesian-join :vars (eaUsed index varIdentity eaDef) :sources
          // ((RegDefUseLiveVarUsed :handle 7 :prefix (blockUsed mvar)) (RegDefUseLiveVarDef :handle
          ...
          for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
            ...
            auto eaUsed = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
                2, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
            auto index = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
                3, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
            auto varIdentity = view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.get_value(
                2, h_RegDefUseLiveVarDef_8_6.begin() + idx1_10);
            auto eaDef = view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.get_value(
                3, h_RegDefUseLiveVarDef_8_6.begin() + idx1_10);
...
JitRunner_RegDefUsed2_D2::LaunchParams JitRunner_RegDefUsed2_D2::setup(DB& db, uint32_t iteration,
                                                                       GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_RegDefUsed2_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                  GPU_STREAM_T stream) {
