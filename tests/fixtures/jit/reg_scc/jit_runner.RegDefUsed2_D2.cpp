// =============================================================
// JIT-Generated Complete Runner: RegDefUsed2_D2
// Fully concrete - NO C++ templates/metaprogramming
// =============================================================

struct JitRunner_RegDefUsed2_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        // MIR: (column-join :var blockUsed :sources ((RegDefUseLiveVarUsed :handle 0) (RegDefUseLiveVarAtBlockEnd :handle 1) ))
        ...
        auto h_RegDefUseLiveVarAtBlockEnd_3_13 = h_RegDefUseLiveVarAtBlockEnd_1_root;
        auto h_RegDefUseLiveVarDef_4_14 = HandleType(0, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.num_rows_, 0);
        auto intersect_15 = intersect_handles(tile, h_RegDefUseLiveVarUsed_2_12.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER), h_RegDefUseLiveVarAtBlockEnd_3_13.iterators(view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER), h_RegDefUseLiveVarDef_4_14.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
        for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
          ...
          auto ch_RegDefUseLiveVarAtBlockEnd_3_mvar = h_RegDefUseLiveVarAtBlockEnd_3_13.child_range(positions[1], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
          auto ch_RegDefUseLiveVarDef_4_mvar = h_RegDefUseLiveVarDef_4_14.child_range(positions[2], mvar, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'blk' from 2 sources
        // MIR: (column-join :var blk :sources ((RegDefUseLiveVarAtBlockEnd :handle 5 :prefix (blockUsed mvar)) (RegDefUseLiveVarDef :handle 6 :prefix (mvar)) ))
        auto h_RegDefUseLiveVarAtBlockEnd_5_8 = ch_RegDefUseLiveVarAtBlockEnd_3_mvar;
        auto h_RegDefUseLiveVarDef_6_9 = ch_RegDefUseLiveVarDef_4_mvar;
        auto intersect_10 = intersect_handles(tile, h_RegDefUseLiveVarAtBlockEnd_5_8.iterators(view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER), h_RegDefUseLiveVarDef_6_9.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto blk = it_11.value();
          auto positions = it_11.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_5_blk = h_RegDefUseLiveVarAtBlockEnd_5_8.child_range(positions[0], blk, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
          auto ch_RegDefUseLiveVarDef_6_blk = h_RegDefUseLiveVarDef_6_9.child_range(positions[1], blk, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
        // Nested CartesianJoin: bind eaUsed, index, varIdentity, eaDef from 2 source(s)
        // MIR: (cartesian-join :vars (eaUsed index varIdentity eaDef) :sources ((RegDefUseLiveVarUsed :handle 7 :prefix (blockUsed mvar)) (RegDefUseLiveVarDef :handle 8 :prefix (mvar blk)) ))
        ...
        auto h_RegDefUseLiveVarDef_8_6 = ch_RegDefUseLiveVarDef_6_blk;  // reusing narrowed handle

        if (!h_RegDefUseLiveVarUsed_7_4.valid() || !h_RegDefUseLiveVarDef_8_6.valid()) continue;

        uint32_t degree_3 = h_RegDefUseLiveVarUsed_7_4.degree();
        uint32_t degree_5 = h_RegDefUseLiveVarDef_8_6.degree();
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        auto h_RegDefUseLiveVarAtBlockEnd_3_17 = h_RegDefUseLiveVarAtBlockEnd_1_root;
        auto h_RegDefUseLiveVarDef_4_18 = HandleType(0, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.num_rows_, 0);
        auto intersect_19 = intersect_handles(tile, h_RegDefUseLiveVarUsed_2_16.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER), h_RegDefUseLiveVarAtBlockEnd_3_17.iterators(view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER), h_RegDefUseLiveVarDef_4_18.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
        for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
          ...
          auto ch_RegDefUseLiveVarAtBlockEnd_3_mvar = h_RegDefUseLiveVarAtBlockEnd_3_17.child_range(positions[1], mvar, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
          auto ch_RegDefUseLiveVarDef_4_mvar = h_RegDefUseLiveVarDef_4_18.child_range(positions[2], mvar, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'blk' from 2 sources
        // MIR: (column-join :var blk :sources ((RegDefUseLiveVarAtBlockEnd :handle 5 :prefix (blockUsed mvar)) (RegDefUseLiveVarDef :handle 6 :prefix (mvar)) ))
        auto h_RegDefUseLiveVarAtBlockEnd_5_12 = ch_RegDefUseLiveVarAtBlockEnd_3_mvar;
        auto h_RegDefUseLiveVarDef_6_13 = ch_RegDefUseLiveVarDef_4_mvar;
        auto intersect_14 = intersect_handles(tile, h_RegDefUseLiveVarAtBlockEnd_5_12.iterators(view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER), h_RegDefUseLiveVarDef_6_13.iterators(view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          auto blk = it_15.value();
          auto positions = it_15.positions();
          auto ch_RegDefUseLiveVarAtBlockEnd_5_blk = h_RegDefUseLiveVarAtBlockEnd_5_12.child_range(positions[0], blk, tile, view_RegDefUseLiveVarAtBlockEnd_1_2_0_FULL_VER);
          auto ch_RegDefUseLiveVarDef_6_blk = h_RegDefUseLiveVarDef_6_13.child_range(positions[1], blk, tile, view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER);
        // Nested CartesianJoin: bind eaUsed, index, varIdentity, eaDef from 2 source(s)
        // MIR: (cartesian-join :vars (eaUsed index varIdentity eaDef) :sources ((RegDefUseLiveVarUsed :handle 7 :prefix (blockUsed mvar)) (RegDefUseLiveVarDef :handle 8 :prefix (mvar blk)) ))
        uint32_t lane_1 = tile.thread_rank();
        uint32_t group_size_2 = tile.size();
        ...
        for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
          ...
          auto eaUsed = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(2, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
          auto index = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(3, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
          auto varIdentity = view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.get_value(2, h_RegDefUseLiveVarDef_8_6.begin() + idx1_10);
          auto eaDef = view_RegDefUseLiveVarDef_2_0_1_3_FULL_VER.get_value(3, h_RegDefUseLiveVarDef_8_6.begin() + idx1_10);
...
JitRunner_RegDefUsed2_D2::LaunchParams JitRunner_RegDefUsed2_D2::setup(DB& db, uint32_t iteration, GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  // Source 1: RegDefUseLiveVarAtBlockEnd version FULL_VER
  {
  ...
  {
    auto& rel_4 = get_relation_by_schema<RegDefUseLiveVarDef, FULL_VER>(db);
    auto& idx_4 = rel_4.ensure_index(SRDatalog::IndexSpec{{2, 0, 1, 3}}, false);
...
void JitRunner_RegDefUsed2_D2::launch_count(LaunchParams& p, GPU_STREAM_T stream) {
...
uint32_t JitRunner_RegDefUsed2_D2::scan_and_resize(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed2_D2::scan_only(LaunchParams& p, GPU_STREAM_T stream) {
  if (p.num_threads == 0) return;
  thrust::exclusive_scan(rmm::exec_policy(stream), p.thread_counts_ptr, p.thread_counts_ptr + p.num_threads + 1, p.thread_counts_ptr, 0, thrust::plus<uint32_t>());
}

// Phase 3b: Read total count (call after device sync)
uint32_t JitRunner_RegDefUsed2_D2::read_total(LaunchParams& p) {
...
void JitRunner_RegDefUsed2_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed2_D2::launch_fused(DB& db, LaunchParams& p, GPU_STREAM_T stream) {
...
void JitRunner_RegDefUsed2_D2::read_fused_result(LaunchParams& p) {
...
void JitRunner_RegDefUsed2_D2::execute(DB& db, uint32_t iteration) {
  nvtxRangePushA("RegDefUsed2_D2");
...
void JitRunner_RegDefUsed2_D2::execute_fused(DB& db, uint32_t iteration) {
  auto p = setup(db, iteration);
  if (p.num_unique_root_keys == 0) return;
