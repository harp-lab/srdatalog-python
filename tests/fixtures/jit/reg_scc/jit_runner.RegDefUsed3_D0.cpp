  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto intersect_15 = intersect_handles(
          tile,
          h_RegDefUseLiveVarAtPriorUsed_2_12.iterators(
              view_RegDefUseLiveVarAtPriorUsed_0_2_1_DELTA_VER),
          h_RegDefUseDefUsed_3_13.iterators(view_RegDefUseDefUsed_2_1_0_3_FULL_VER),
      ...
      for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
        ...
        auto ch_RegDefUseLiveVarAtPriorUsed_2_mvar = h_RegDefUseLiveVarAtPriorUsed_2_12.child_range(
            positions[0], mvar, tile, view_RegDefUseLiveVarAtPriorUsed_0_2_1_DELTA_VER);
        auto ch_RegDefUseDefUsed_3_mvar = h_RegDefUseDefUsed_3_13.child_range(
...
JitRunner_RegDefUsed3_D0::LaunchParams JitRunner_RegDefUsed3_D0::setup(DB& db, uint32_t iteration,
                                                                       GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  // Source 0: RegDefUseLiveVarAtPriorUsed version DELTA_VER
  {
    auto& rel_0 = (iteration == 0)
                      ? get_relation_by_schema<RegDefUseLiveVarAtPriorUsed, FULL_VER>(db)
                      : get_relation_by_schema<RegDefUseLiveVarAtPriorUsed, DELTA_VER>(db);
...
void JitRunner_RegDefUsed3_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                  GPU_STREAM_T stream) {
