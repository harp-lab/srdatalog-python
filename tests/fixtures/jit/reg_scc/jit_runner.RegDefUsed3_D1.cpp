...
struct JitRunner_RegDefUsed3_D1 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    // MIR: (column-join :var eaUsed :sources ((RegDefUseDefUsed :handle 0)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      uint32_t hint_hi_4 =
          view_RegDefUseDefUsed_2_1_0_3_DELTA_VER.num_rows_ - (num_unique_root_keys - y_idx_1 - 1);
      hint_hi_4 = (hint_hi_4 <= view_RegDefUseDefUsed_2_1_0_3_DELTA_VER.num_rows_)
                      ? hint_hi_4
                      : view_RegDefUseDefUsed_2_1_0_3_DELTA_VER.num_rows_;
      hint_hi_4 =
          (hint_hi_4 > hint_lo_3) ? hint_hi_4 : view_RegDefUseDefUsed_2_1_0_3_DELTA_VER.num_rows_;
      auto h_RegDefUseDefUsed_0_root =
          HandleType(hint_lo_3, hint_hi_4, 0)
              .prefix(root_val_2, tile, view_RegDefUseDefUsed_2_1_0_3_DELTA_VER);
      if (!h_RegDefUseDefUsed_0_root.valid())
        continue;
      auto h_RegDefUseLiveVarAtPriorUsed_1_root =
          HandleType(0, view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER);
      ...
      // MIR: (column-join :var mvar :sources ((RegDefUseDefUsed :handle 2 :prefix (eaUsed))
      // (RegDefUseLiveVarAtPriorUsed :handle 3 :prefix (eaUsed)) (RegDefUseLiveVarUsed :handle 4
      // :prefix ()) ))
      ...
      auto h_RegDefUseLiveVarUsed_4_14 =
          HandleType(0, view_RegDefUseLiveVarUsed_1_0_2_3_FULL_VER.num_rows_, 0);
      auto intersect_15 = intersect_handles(
          tile, h_RegDefUseDefUsed_2_12.iterators(view_RegDefUseDefUsed_2_1_0_3_DELTA_VER),
          h_RegDefUseLiveVarAtPriorUsed_3_13.iterators(
              view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER),
          h_RegDefUseLiveVarUsed_4_14.iterators(view_RegDefUseLiveVarUsed_1_0_2_3_FULL_VER));
      for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
        auto mvar = it_16.value();
        auto positions = it_16.positions();
        auto ch_RegDefUseDefUsed_2_mvar = h_RegDefUseDefUsed_2_12.child_range(
            positions[0], mvar, tile, view_RegDefUseDefUsed_2_1_0_3_DELTA_VER);
        auto ch_RegDefUseLiveVarAtPriorUsed_3_mvar = h_RegDefUseLiveVarAtPriorUsed_3_13.child_range(
            positions[1], mvar, tile, view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER);
        auto ch_RegDefUseLiveVarUsed_4_mvar = h_RegDefUseLiveVarUsed_4_14.child_range(
        ...
        auto intersect_10 = intersect_handles(
            ...
            h_RegDefUseLiveVarAtPriorUsed_5_8.iterators(
                view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER),
            h_RegDefUseLiveVarUsed_6_9.iterators(view_RegDefUseLiveVarUsed_1_0_2_3_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          ...
          auto ch_RegDefUseLiveVarAtPriorUsed_5_nxtBlk =
              h_RegDefUseLiveVarAtPriorUsed_5_8.child_range(
                  positions[0], nxtBlk, tile, view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER);
          auto ch_RegDefUseLiveVarUsed_6_nxtBlk = h_RegDefUseLiveVarUsed_6_9.child_range(
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto intersect_19 = intersect_handles(
          tile, h_RegDefUseDefUsed_2_16.iterators(view_RegDefUseDefUsed_2_1_0_3_DELTA_VER),
      ...
      for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
        ...
        auto ch_RegDefUseDefUsed_2_mvar = h_RegDefUseDefUsed_2_16.child_range(
            positions[0], mvar, tile, view_RegDefUseDefUsed_2_1_0_3_DELTA_VER);
        ...
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          ...
          for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
            ...
            auto eaDef = view_RegDefUseDefUsed_2_1_0_3_DELTA_VER.get_value(
                2, h_RegDefUseDefUsed_7_4.begin() + idx0_9);
            auto _gen1 = view_RegDefUseDefUsed_2_1_0_3_DELTA_VER.get_value(
...
JitRunner_RegDefUsed3_D1::LaunchParams JitRunner_RegDefUsed3_D1::setup(DB& db, uint32_t iteration,
                                                                       GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<RegDefUseDefUsed, FULL_VER>(db)
                                   : get_relation_by_schema<RegDefUseDefUsed, DELTA_VER>(db);
  ...
  auto& first_rel = (iteration == 0) ? get_relation_by_schema<RegDefUseDefUsed, FULL_VER>(db)
                                     : get_relation_by_schema<RegDefUseDefUsed, DELTA_VER>(db);
...
void JitRunner_RegDefUsed3_D1::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                  GPU_STREAM_T stream) {
