...
struct JitRunner_RegDefUsed3_D1 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        auto view_RegDefUseLiveVarUsed_1_0_2_3_FULL_VER = views[2];
        ...
        for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
          ...
          auto h_RegDefUseLiveVarAtPriorUsed_1_root = HandleType(0, view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER.num_rows_, 0).prefix(root_val_2, tile, view_RegDefUseLiveVarAtPriorUsed_0_2_1_FULL_VER);
