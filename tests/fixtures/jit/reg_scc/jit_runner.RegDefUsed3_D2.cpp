...
struct JitRunner_RegDefUsed3_D2 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    // MIR: (column-join :var nxtBlk :sources ((RegDefUseLiveVarUsed :handle 0)
    // (RegDefUseLiveVarAtPriorUsed :handle 1) )) WARP MODE: 32 threads cooperatively handle one row
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      auto root_val_2 = root_unique_values[y_idx_1];

      uint32_t hint_lo_3 = y_idx_1;
      uint32_t hint_hi_4 = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_ -
                           (num_unique_root_keys - y_idx_1 - 1);
      hint_hi_4 = (hint_hi_4 <= view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_)
                      ? hint_hi_4
                      : view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_;
      hint_hi_4 = (hint_hi_4 > hint_lo_3) ? hint_hi_4
                                          : view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.num_rows_;
      auto h_RegDefUseLiveVarUsed_0_root =
          HandleType(hint_lo_3, hint_hi_4, 0)
              .prefix(root_val_2, tile, view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER);
      if (!h_RegDefUseLiveVarUsed_0_root.valid())
        continue;
      auto h_RegDefUseLiveVarAtPriorUsed_1_root =
          HandleType(0, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER.num_rows_, 0)
              .prefix(root_val_2, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
      if (!h_RegDefUseLiveVarAtPriorUsed_1_root.valid())
        continue;
      auto nxtBlk = root_val_2;
      // Nested ColumnJoin (intersection): bind 'mvar' from 3 sources
      // MIR: (column-join :var mvar :sources ((RegDefUseLiveVarUsed :handle 2 :prefix (nxtBlk))
      // (RegDefUseLiveVarAtPriorUsed :handle 3 :prefix (nxtBlk)) (RegDefUseDefUsed :handle 4
      // :prefix ()) ))
      ...
      auto h_RegDefUseDefUsed_4_14 =
          HandleType(0, view_RegDefUseDefUsed_1_2_0_3_FULL_VER.num_rows_, 0);
      auto intersect_15 = intersect_handles(
          tile, h_RegDefUseLiveVarUsed_2_12.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER),
          h_RegDefUseLiveVarAtPriorUsed_3_13.iterators(
              view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER),
          h_RegDefUseDefUsed_4_14.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
      for (auto it_16 = intersect_15.begin(); it_16.valid(); it_16.next()) {
        auto mvar = it_16.value();
        auto positions = it_16.positions();
        auto ch_RegDefUseLiveVarUsed_2_mvar = h_RegDefUseLiveVarUsed_2_12.child_range(
            positions[0], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER);
        auto ch_RegDefUseLiveVarAtPriorUsed_3_mvar = h_RegDefUseLiveVarAtPriorUsed_3_13.child_range(
            positions[1], mvar, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
        auto ch_RegDefUseDefUsed_4_mvar = h_RegDefUseDefUsed_4_14.child_range(
            positions[2], mvar, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'eaUsed' from 2 sources
        // MIR: (column-join :var eaUsed :sources ((RegDefUseLiveVarAtPriorUsed :handle 5 :prefix
        // (nxtBlk mvar)) (RegDefUseDefUsed :handle 6 :prefix (mvar)) ))
        ...
        auto intersect_10 = intersect_handles(
            tile,
            h_RegDefUseLiveVarAtPriorUsed_5_8.iterators(
                view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER),
            h_RegDefUseDefUsed_6_9.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
        for (auto it_11 = intersect_10.begin(); it_11.valid(); it_11.next()) {
          auto eaUsed = it_11.value();
          auto positions = it_11.positions();
          auto ch_RegDefUseLiveVarAtPriorUsed_5_eaUsed =
              h_RegDefUseLiveVarAtPriorUsed_5_8.child_range(
                  positions[0], eaUsed, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
          auto ch_RegDefUseDefUsed_6_eaUsed = h_RegDefUseDefUsed_6_9.child_range(
              positions[1], eaUsed, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
          ...
          // ((RegDefUseLiveVarUsed :handle 7 :prefix (nxtBlk mvar)) (RegDefUseDefUsed :handle 8
          // :prefix (mvar eaUsed)) ))
          uint32_t lane_1 = tile.thread_rank();
          uint32_t group_size_2 = tile.size();

          auto h_RegDefUseLiveVarUsed_7_4 =
              ch_RegDefUseLiveVarUsed_2_mvar;                          // reusing narrowed handle
          auto h_RegDefUseDefUsed_8_6 = ch_RegDefUseDefUsed_6_eaUsed;  // reusing narrowed handle

          if (!h_RegDefUseLiveVarUsed_7_4.valid() || !h_RegDefUseDefUsed_8_6.valid())
            continue;
          ...
          // Count-as-product: per-lane share without inner loop
          {
            ...
            uint32_t lane_share = (lane_1 < lane_total)
                                      ? ((lane_total - lane_1 + group_size_2 - 1) / group_size_2)
                                      : 0;
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto h_RegDefUseDefUsed_4_18 =
          HandleType(0, view_RegDefUseDefUsed_1_2_0_3_FULL_VER.num_rows_, 0);
      auto intersect_19 = intersect_handles(
          tile, h_RegDefUseLiveVarUsed_2_16.iterators(view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER),
          h_RegDefUseLiveVarAtPriorUsed_3_17.iterators(
              view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER),
          h_RegDefUseDefUsed_4_18.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
      for (auto it_20 = intersect_19.begin(); it_20.valid(); it_20.next()) {
        auto mvar = it_20.value();
        auto positions = it_20.positions();
        auto ch_RegDefUseLiveVarUsed_2_mvar = h_RegDefUseLiveVarUsed_2_16.child_range(
            positions[0], mvar, tile, view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER);
        auto ch_RegDefUseLiveVarAtPriorUsed_3_mvar = h_RegDefUseLiveVarAtPriorUsed_3_17.child_range(
            positions[1], mvar, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
        auto ch_RegDefUseDefUsed_4_mvar = h_RegDefUseDefUsed_4_18.child_range(
            positions[2], mvar, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
        // Nested ColumnJoin (intersection): bind 'eaUsed' from 2 sources
        // MIR: (column-join :var eaUsed :sources ((RegDefUseLiveVarAtPriorUsed :handle 5 :prefix
        // (nxtBlk mvar)) (RegDefUseDefUsed :handle 6 :prefix (mvar)) ))
        ...
        auto intersect_14 = intersect_handles(
            ...
            h_RegDefUseLiveVarAtPriorUsed_5_12.iterators(
                view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER),
            h_RegDefUseDefUsed_6_13.iterators(view_RegDefUseDefUsed_1_2_0_3_FULL_VER));
        for (auto it_15 = intersect_14.begin(); it_15.valid(); it_15.next()) {
          ...
          auto ch_RegDefUseLiveVarAtPriorUsed_5_eaUsed =
              h_RegDefUseLiveVarAtPriorUsed_5_12.child_range(
                  positions[0], eaUsed, tile, view_RegDefUseLiveVarAtPriorUsed_1_2_0_FULL_VER);
          auto ch_RegDefUseDefUsed_6_eaUsed = h_RegDefUseDefUsed_6_13.child_range(
              positions[1], eaUsed, tile, view_RegDefUseDefUsed_1_2_0_3_FULL_VER);
          // Nested CartesianJoin: bind eaDef, nextEaUsed, nextIndex, _gen1 from 2 source(s)
          // MIR: (cartesian-join :vars (eaDef nextEaUsed nextIndex _gen1) :sources
          // ((RegDefUseLiveVarUsed :handle 7 :prefix (nxtBlk mvar)) (RegDefUseDefUsed :handle 8
          ...
          for (uint32_t flat_idx_8 = lane_1; flat_idx_8 < total_7; flat_idx_8 += group_size_2) {
            ...
            auto nextEaUsed = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
                2, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
            auto nextIndex = view_RegDefUseLiveVarUsed_0_1_2_3_DELTA_VER.get_value(
                3, h_RegDefUseLiveVarUsed_7_4.begin() + idx0_9);
            auto eaDef = view_RegDefUseDefUsed_1_2_0_3_FULL_VER.get_value(
                2, h_RegDefUseDefUsed_8_6.begin() + idx1_10);
            auto _gen1 = view_RegDefUseDefUsed_1_2_0_3_FULL_VER.get_value(
                3, h_RegDefUseDefUsed_8_6.begin() + idx1_10);
...
JitRunner_RegDefUsed3_D2::LaunchParams JitRunner_RegDefUsed3_D2::setup(DB& db, uint32_t iteration,
                                                                       GPU_STREAM_T stream) {
  LaunchParams p;
  ...
  {
    auto& rel_0 = (iteration == 0) ? get_relation_by_schema<RegDefUseLiveVarUsed, FULL_VER>(db)
                                   : get_relation_by_schema<RegDefUseLiveVarUsed, DELTA_VER>(db);
  ...
  auto& first_rel = (iteration == 0) ? get_relation_by_schema<RegDefUseLiveVarUsed, FULL_VER>(db)
                                     : get_relation_by_schema<RegDefUseLiveVarUsed, DELTA_VER>(db);
...
void JitRunner_RegDefUsed3_D2::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                  GPU_STREAM_T stream) {
