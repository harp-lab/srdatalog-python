...
struct JitRunner_RegDefUsed4_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize)
    ...
    for (uint32_t y_idx_1 = warp_id; y_idx_1 < num_unique_root_keys; y_idx_1 += num_warps) {
      ...
      auto h_RegDefUseBlockLastDef_3_15 =
          HandleType(0, view_RegDefUseBlockLastDef_2_0_1_FULL_VER.num_rows_, 0);
      auto intersect_16 = intersect_handles(
          tile,
          h_RegDefUseReturnValUsed_2_14.iterators(view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER),
          h_RegDefUseBlockLastDef_3_15.iterators(view_RegDefUseBlockLastDef_2_0_1_FULL_VER));
      for (auto it_17 = intersect_16.begin(); it_17.valid(); it_17.next()) {
        auto reg = it_17.value();
        auto positions = it_17.positions();
        auto ch_RegDefUseReturnValUsed_2_reg = h_RegDefUseReturnValUsed_2_14.child_range(
            positions[0], reg, tile, view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER);
        auto ch_RegDefUseBlockLastDef_3_reg = h_RegDefUseBlockLastDef_3_15.child_range(
        ...
        auto intersect_12 = intersect_handles(
            tile,
            h_RegDefUseReturnBlockEnd_4_10.iterators(view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER),
            h_RegDefUseBlockLastDef_5_11.iterators(view_RegDefUseBlockLastDef_2_0_1_FULL_VER));
        for (auto it_13 = intersect_12.begin(); it_13.valid(); it_13.next()) {
          auto blockEnd = it_13.value();
          auto positions = it_13.positions();
          auto ch_RegDefUseReturnBlockEnd_4_blockEnd = h_RegDefUseReturnBlockEnd_4_10.child_range(
              positions[0], blockEnd, tile, view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER);
          auto ch_RegDefUseBlockLastDef_5_blockEnd = h_RegDefUseBlockLastDef_5_11.child_range(
...
JitRunner_RegDefUsed4_D0::LaunchParams JitRunner_RegDefUsed4_D0::setup(DB& db, uint32_t iteration,
                                                                       GPU_STREAM_T stream) {
  LaunchParams p;
...
void JitRunner_RegDefUsed4_D0::launch_materialize(DB& db, LaunchParams& p, uint32_t total_count,
                                                  GPU_STREAM_T stream) {
