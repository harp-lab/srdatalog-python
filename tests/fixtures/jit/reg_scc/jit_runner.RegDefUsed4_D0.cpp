...
struct JitRunner_RegDefUsed4_D0 {
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_count(
    ...
    OutputCtx output_ctx{nullptr, nullptr, 0, 0};
        ...
        // MIR: (cartesian-join :vars (_gen2 eaUsed index _gen3 _gen4 eaDef) :sources ((RegDefUseReturnValUsed :handle 6 :prefix (callee reg)) (RegDefUseReturnBlockEnd :handle 7 :prefix (callee blockEnd)) (RegDefUseBlockLastDef :handle 8 :prefix (reg blockEnd)) ))
  ...
  static __global__ void __launch_bounds__(kBlockSize) kernel_materialize(
    ...
    OutputCtx_0 output_ctx_0{output_data_0, output_prov_0, output_stride_0, old_size_0 + thread_offset};
        ...
        for (uint32_t flat_idx_10 = lane_1; flat_idx_10 < total_9; flat_idx_10 += group_size_2) {
          ...
          auto _gen2 = view_RegDefUseReturnValUsed_1_2_0_3_4_DELTA_VER.get_value(2, h_RegDefUseReturnValUsed_6_4.begin() + idx0_11);
          ...
          auto _gen3 = view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER.get_value(2, h_RegDefUseReturnBlockEnd_7_6.begin() + idx1_12);
          auto _gen4 = view_RegDefUseReturnBlockEnd_0_3_1_2_FULL_VER.get_value(3, h_RegDefUseReturnBlockEnd_7_6.begin() + idx1_12);
