...
def build_reg_scc() -> Program:
  ...
  INDEX = Var("index")
  BLK = Var("blk")
  BLOCK_USED = Var("blockUsed")
  VAR_ID = Var("varIdentity")
  NXT_BLK = Var("nxtBlk")
  NEXT_EA = Var("nextEaUsed")
  NEXT_IDX = Var("nextIndex")
  CALLEE = Var("callee")
  REG = Var("reg")
  BLOCK_END = Var("blockEnd")
  EA_CALL = Var("eaCall")
  INDEX_USED = Var("indexUsed")
  PREV_BLK = Var("prevBlock")
  PREV_END = Var("prevBlockEnd")
  RET_BLK = Var("retBlock")
  RET_END = Var("retBlockEnd")
  G1 = Var("_gen1")
  G2 = Var("_gen2")
  G3 = Var("_gen3")
  G4 = Var("_gen4")
  ...
  return Program(
    ...
    rules=[
      ...
      (
        ...
        <= used_in_block(BLK, EA_USED, MVAR, INDEX) & ~blkld(EA_USED, G5, MVAR)
      ).named("LiveVarUsed1"),
      (
      ...
      (
        ...
        <= live_at_end(BLK, BLOCK_USED, MVAR) & ~ref_in(BLK, MVAR) & block_next(PREV_BLK, G13, BLK)
