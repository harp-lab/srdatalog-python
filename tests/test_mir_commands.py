...
class TestScan(unittest.TestCase):
  ...
  def test_scan_with_index_and_full_version(self):
    ...
    output = str(scan)
    expected = (
      'SRDatalog::mir::dsl::scan_h<'
      + str(MISSING_HANDLE)
      + ', decltype(boost::hana::make_map())>(SRDatalog::mir::dsl::vars("y"_v, "x"_v),SRDatalog::mir::dsl::index<AddressOf, 0, 1>().full())'
    )
  ...
  def test_nonrecursive_pipeline(self):
    structure = ExecutePipeline(
      ...
      body=[
        ...
        InsertInto(
          fact=FactIndex(Relation_PointsTo, [1, 0]), version=Version.NEW, terms=("y", "x")
        ),
      ],
    )

    expected = (
      'execute(pipeline<std::tuple<SRDatalog::mir::IndexSpecT<AddressOf,std::integer_sequence<int,0,1>,0>>,std::tuple<SRDatalog::mir::IndexSpecT<PointsTo,std::integer_sequence<int,1,0>,0>>,std::tuple<AddressOf>>(SRDatalog::mir::dsl::scan_h<'
      + str(MISSING_HANDLE)
      + ',decltype(boost::hana::make_map())>(SRDatalog::mir::dsl::vars("y"_v,"x"_v),SRDatalog::mir::dsl::index<AddressOf,0,1>().full()),insert_into<PointsTo,NEW_VER,decltype(SRDatalog::mir::dsl::index<PointsTo,1,0>().newt())>("y"_v,"x"_v)))'
    )
...
class TestColumnSource(unittest.TestCase):
  def test_noprefix(self):
    ...
    expected = (
      'SRDatalog::mir::dsl::column_source(SRDatalog::mir::dsl::index<PointsTo, 0, 1>().delta())'
    )
  ...
  def test_prefix(self):
    ...
    expected = (
      'SRDatalog::mir::dsl::column_source(SRDatalog::mir::dsl::index<PointsTo,0,1>().delta(),"x"_v)'
    )
    actual = str(structure).replace(" ", "").replace("\n", "")  # remove whitespace formatting
    self.assertEqual(actual, expected)
...
class TestColumnJoin(unittest.TestCase):
  def test_prefix(self):
    ...
    expected = (
      ...
      + str(MISSING_HANDLE)
      + ', decltype(boost::hana::make_map())>("z"_v, SRDatalog::mir::dsl::column_source(SRDatalog::mir::dsl::index<PointsTo, 0, 1>().delta()), SRDatalog::mir::dsl::column_source(SRDatalog::mir::dsl::index<Assign, 1, 0>().full()))'
    )
    actual = str(structure).replace(" ", "").replace("\n", "")  # remove whitespace formatting
...
class TestCartesianJoin(unittest.TestCase):
  def test_two_prefix(self):
    ...
    expected = (
      ...
      + str(MISSING_HANDLE)
      + ', decltype(boost::hana::make_map(boost::hana::make_pair(boost::hana::type_c<SRDatalog::AST::Var<decltype("x"_s)>>, std::integer_sequence<std::size_t, 0>{}), boost::hana::make_pair(boost::hana::type_c<SRDatalog::AST::Var<decltype("z"_s)>>, std::integer_sequence<std::size_t, 1>{})))>(SRDatalog::mir::dsl::vars("y"_v, "w"_v), SRDatalog::mir::dsl::column_source(SRDatalog::mir::dsl::index<Load, 1, 0>().full(), "x"_v), SRDatalog::mir::dsl::column_source(SRDatalog::mir::dsl::index<PointsTo, 0, 1>().full(), "z"_v))'
    )
    actual = str(structure).replace(" ", "").replace("\n", "")  # remove whitespace formatting
    expected = expected.replace(" ", "").replace("\n", "")  # remove whitespace formatting
...
class TestMirInstructions(unittest.TestCase):
  ...
  def test_program_nohandles(self):
    ...
    actual = (
      str(self.program_nh.cpp()).replace(" ", "").replace("\n", "")
    )  # remove whitespace formatting
  ...
  def test_program_handles(self):
    ...
    actual = (
      str(self.program_h.cpp()).replace(" ", "").replace("\n", "")
    )  # remove whitespace formatting
...
class TestNegate(unittest.TestCase):
  def test_negationtest_basic(self):
    ...
    expected = (
      'SRDatalog::mir::dsl::negation_h<'
      + str(MISSING_HANDLE)
      + ', decltype(boost::hana::make_map())>(SRDatalog::mir::dsl::index<HasNextSibling, 0, 1>().full(), SRDatalog::mir::dsl::vars("StartCtr"_v, "StartN"_v))'
    )
